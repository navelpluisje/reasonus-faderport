...
local screen = app:add_screen {
  name = 'create-plugin-zone',
  init = function(_, screen)
    screen.widget = pages.createPluginZoneFile.create(nbMixManagementFilters, window, true)
  end,
}
