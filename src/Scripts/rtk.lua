...
rtk = (function()
    __mod_rtk_core = (function()
        __mod_rtk_log = (function()
            local log = { levels = { [50] = 'CRITICAL', [40] = 'ERROR', [30] = 'WARNING', [20] = 'INFO', [10] = 'DEBUG',
                [9] = 'DEBUG2', }, level = 40, timer_threshold = 20, named_timers = nil, timers = {}, queue = {},
                lua_time_start = os.time(), reaper_time_start = reaper.time_precise(), }
            log.CRITICAL = 50
            log.ERROR = 40
            log.WARNING = 30
            log.INFO = 20
            ...
            function log.flush() local str = table.concat(log.queue)
                if #str > 0 then
        ...
        local rtk = { touchscroll = false, smoothscroll = true, touch_activate_delay = 0.1, long_press_delay = 0.5,
            double_click_delay = 0.5, tooltip_delay = 0.5, light_luma_threshold = 0.6, debug = false,
            has_js_reascript_api = (reaper.JS_Window_GetFocus ~= nil),
            has_sws_extension = (reaper.BR_Win32_GetMonitorRectFromRect ~= nil), script_path = nil, reaper_hwnd = nil,
            fps = 30, focused_hwnd = nil, focused = nil, theme = nil, _dest_stack = {}, _image_paths = {}, _animations = {},
            _animations_len = 0, _easing_functions = {}, _frame_count = 0, _frame_time = nil, _modal = nil,
            _touch_activate_event = nil, _last_traceback = nil, _last_error = nil, _quit = false,
            _refs = setmetatable({}, { __mode = 'v' }), _run_soon = nil, _reactive_attr = {}, }
        rtk.scale = setmetatable({ user = nil, _user = 1.0, system = nil, reaper = 1.0, framebuffer = nil, value = 1.0,
            _discover = function() local inifile = reaper.get_ini_file()
                ...
                rtk.scale._calc()
            end, _calc = function() local value = rtk.scale.user * rtk.scale.system * rtk.scale.reaper
        ...
        rtk.os = { mac = (_os == 'osx' or _os == 'mac'), windows = (_os == 'win'), linux = (_os == 'lin' or _os == 'oth'
            ), bits = 32, }
        rtk.mouse = { BUTTON_LEFT = 1, BUTTON_MIDDLE = 64, BUTTON_RIGHT = 2, BUTTON_MASK = (1 | 2 | 64), x = 0, y = 0,
            down = 0, state = { order = {} } }
        local _load_cursor
        ...
        rtk.mouse.cursors = { UNDEFINED = 0, POINTER = _load_cursor(32512), BEAM = _load_cursor(32513),
            LOADING = _load_cursor(32514), CROSSHAIR = _load_cursor(32515), UP_ARROW = _load_cursor(32516),
            SIZE_NW_SE = _load_cursor(rtk.os.linux and 32643 or 32642),
            SIZE_SW_NE = _load_cursor(rtk.os.linux and 32642 or 32643), SIZE_EW = _load_cursor(32644),
            SIZE_NS = _load_cursor(32645), MOVE = _load_cursor(32646), INVALID = _load_cursor(32648),
            HAND = _load_cursor(32649), POINTER_LOADING = _load_cursor(32650), POINTER_HELP = _load_cursor(32651),
            REAPER_FADEIN_CURVE = _load_cursor(105), REAPER_FADEOUT_CURVE = _load_cursor(184),
            REAPER_CROSSFADE = _load_cursor(463), REAPER_DRAGDROP_COPY = _load_cursor(182),
            REAPER_DRAGDROP_RIGHT = _load_cursor(1011), REAPER_POINTER_ROUTING = _load_cursor(186),
            REAPER_POINTER_MOVE = _load_cursor(187), REAPER_POINTER_MARQUEE_SELECT = _load_cursor(488),
            REAPER_POINTER_DELETE = _load_cursor(464), REAPER_POINTER_LEFTRIGHT = _load_cursor(465),
            REAPER_POINTER_ARMED_ACTION = _load_cursor(434), REAPER_MARKER_HORIZ = _load_cursor(188),
            REAPER_MARKER_VERT = _load_cursor(189), REAPER_ADD_TAKE_MARKER = _load_cursor(190),
            REAPER_TREBLE_CLEF = _load_cursor(191), REAPER_BORDER_LEFT = _load_cursor(417),
            REAPER_BORDER_RIGHT = _load_cursor(418), REAPER_BORDER_TOP = _load_cursor(419),
            REAPER_BORDER_BOTTOM = _load_cursor(421), REAPER_BORDER_LEFTRIGHT = _load_cursor(450),
            REAPER_VERTICAL_LEFTRIGHT = _load_cursor(462), REAPER_GRID_RIGHT = _load_cursor(460),
            REAPER_GRID_LEFT = _load_cursor(461), REAPER_HAND_SCROLL = _load_cursor(429),
            REAPER_FIST_LEFT = _load_cursor(430), REAPER_FIST_RIGHT = _load_cursor(431),
            REAPER_FIST_BOTH = _load_cursor(453), REAPER_PENCIL = _load_cursor(185), REAPER_PENCIL_DRAW = _load_cursor(433),
            REAPER_ERASER = _load_cursor(472), REAPER_BRUSH = _load_cursor(473), REAPER_ARP = _load_cursor(502),
            REAPER_CHORD = _load_cursor(503), REAPER_TOUCHSEL = _load_cursor(515), REAPER_SWEEP = _load_cursor(517),
            REAPER_FADEIN_CURVE_ALT = _load_cursor(525), REAPER_FADEOUT_CURVE_ALT = _load_cursor(526),
            REAPER_XFADE_WIDTH = _load_cursor(528), REAPER_XFADE_CURVE = _load_cursor(529),
            REAPER_EXTMIX_SECTION_RESIZE = _load_cursor(530), REAPER_EXTMIX_MULTI_RESIZE = _load_cursor(531),
            REAPER_EXTMIX_MULTISECTION_RESIZE = _load_cursor(532), REAPER_EXTMIX_RESIZE = _load_cursor(533),
            REAPER_EXTMIX_ALLSECTION_RESIZE = _load_cursor(534), REAPER_EXTMIX_ALL_RESIZE = _load_cursor(535),
            REAPER_ZOOM = _load_cursor(1009), REAPER_INSERT_ROW = _load_cursor(1010), REAPER_RAZOR = _load_cursor(599),
            REAPER_RAZOR_MOVE = _load_cursor(600), REAPER_RAZOR_ADD = _load_cursor(601),
            REAPER_RAZOR_ENVELOPE_VERTICAL = _load_cursor(202), REAPER_RAZOR_ENVELOPE_RIGHT_TILT = _load_cursor(203),
        ...
        rtk.keycodes = { UP = 30064, DOWN = 1685026670, LEFT = 1818584692, RIGHT = 1919379572, RETURN = 13, ENTER = 13,
            SPACE = 32, BACKSPACE = 8, ESCAPE = 27, TAB = 9, HOME = 1752132965, END = 6647396, INSERT = 6909555,
            DELETE = 6579564, F1 = 26161, F2 = 26162, F3 = 26163, F4 = 26164, F5 = 26165, F6 = 26166, F7 = 26167,
            F8 = 26168, F9 = 26169, F10 = 6697264, F11 = 6697265, F12 = 6697266, }
        rtk.themes = { dark = { name = 'dark', dark = true, light = false, bg = '#252525', default_font = { 'Calibri', 18 },
            tooltip_font = { 'Segoe UI (TrueType)', 16 }, tooltip_bg = '#ffffff', tooltip_text = '#000000',
            accent = '#47abff', accent_subtle = '#306088', text = '#ffffff', text_faded = '#bbbbbb', button = '#555555',
            heading = nil, button_label = '#ffffff', button_font = nil, button_gradient_mul = 1, button_tag_alpha = 0.32,
            button_normal_gradient = -0.37, button_normal_border_mul = 0.7, button_hover_gradient = 0.17,
            button_hover_brightness = 0.9, button_hover_mul = 1, button_hover_border_mul = 1.1,
            button_clicked_gradient = 0.47, button_clicked_brightness = 0.9, button_clicked_mul = 0.85,
            button_clicked_border_mul = 1, text_font = nil, heading_font = { 'Calibri', 26 }, entry_font = nil,
            entry_bg = '#5f5f5f7f', entry_placeholder = '#ffffff7f', entry_border_hover = '#3a508e',
            entry_border_focused = '#4960b8', entry_selection_bg = '#0066bb', popup_bg = nil, popup_bg_brightness = 1.5,
            popup_shadow = '#11111166', popup_border = '#385074', slider_font = nil, slider = '#2196f3',
            slider_track = '#5a5a5a', slider_tick_label = nil, },
            light = { name = 'light', light = true, dark = false, accent = '#47abff', accent_subtle = '#a1d3fc',
                bg = '#dddddd', default_font = { 'Calibri', 18 }, tooltip_font = { 'Segoe UI (TrueType)', 16 },
                tooltip_bg = '#ffffff', tooltip_text = '#000000', button = '#dedede', button_label = '#000000',
                button_gradient_mul = 1, button_tag_alpha = 0.15, button_normal_gradient = -0.28,
                button_normal_border_mul = 0.85, button_hover_gradient = 0.12, button_hover_brightness = 1,
                button_hover_mul = 1, button_hover_border_mul = 0.9, button_clicked_gradient = 0.3,
                button_clicked_brightness = 1.0, button_clicked_mul = 0.9, button_clicked_border_mul = 0.7,
                text = '#000000', text_faded = '#555555', heading_font = { 'Calibri', 26 }, entry_border_hover = '#3a508e',
                entry_border_focused = '#4960b8', entry_bg = '#00000020', entry_placeholder = '#0000007f',
                entry_selection_bg = '#9fcef4', popup_bg = nil, popup_bg_brightness = 1.5, popup_shadow = '#11111122',
                popup_border = '#385074', slider = '#2196f3', slider_track = '#5a5a5a', } }
        local function _postprocess_theme() local iconstyle = rtk.colour.get_icon_style(rtk.theme.bg)
            rtk.theme.iconstyle = iconstyle
            for k, v in pairs(rtk.theme) do
                if type(v) == 'string' and v:byte(1) == 35 then
                    local x = { rtk.colour.rgba(v) }
                    rtk.theme[k] = { rtk.colour.rgba(v) }
                end
            end
        end
        ...
        function rtk.set_theme_by_bgcolour(colour, overrides) local name = rtk.colour.luma(colour) >
                rtk.light_luma_threshold and 'light' or 'dark'
        ...
        function rtk.new_theme(name, base, overrides) assert(not base or rtk.themes[base],
            string.format('base theme %s not found', base)) assert(not rtk.themes[name],
            string.format('theme %s already exists', name)) local theme = base and table.shallow_copy(rtk.themes[base])
            or {}
        ...
        function rtk.callafter(duration, func, ...) local args = table.pack(...)
            local start = reaper.time_precise()
            local function sched() if reaper.time_precise() - start >= duration then
        ...
        function rtk.version.parse() local ver = __RTK_VERSION or string.format('%s.99.99', rtk.version._DEFAULT_API)
    ...
    __mod_rtk_type = (function()
        ...
        __mod_rtk_middleclass = (function()
            ...
            local function _createIndexWrapper(aClass, f) if f == nil then
            ...
            local function _propagateInstanceMethod(aClass, name, f) f = name == "__index" and
                    _createIndexWrapper(aClass, f) or f
            ...
            local function _createClass(name, super) local dict = {}
                dict.__index = dict
                local aClass = { name = name, super = super, static = {}, __instanceDict = dict, __declaredMethods = {},
                    subclasses = setmetatable({}, { __mode = 'k' }) }
                if super then
                    setmetatable(aClass.static, { __index = function(_, k) local result = rawget(dict, k)
                        if result == nil then
            ...
            local DefaultMixin = { __tostring = function(self) return "instance of " .. tostring(self.class) end,
                __gc = function(self) if type(self) == 'table' and type(self.class) == 'table' and
                        type(self.class.finalize) == 'function' then
                        self:finalize()
                    end
                end, initialize = function(self, ...) end,
                isInstanceOf = function(self, aClass) return type(aClass) == 'table' and type(self) == 'table' and
                        (self.class == aClass
                            or
                            type(self.class) == 'table' and type(self.class.isSubclassOf) == 'function' and
                            self.class:isSubclassOf(aClass))
                end,
                static = { allocate = function(self) assert(type(self) == 'table',
                    ...
                    new = function(self, ...) assert(type(self) == 'table',
                        "Make sure that you are using 'Class:new' instead of 'Class.new'") local instance = self:
                        allocate() instance:initialize(...) return instance
                    end,
                    subclass = function(self, name) assert(type(self) == 'table',
                        ...
                        return subclass
                    end, subclassed = function(self, other) end,
                    isSubclassOf = function(self, other) return type(other) == 'table' and
                            type(self.super) == 'table' and
                            (self.super == other or self.super:isSubclassOf(other))
                    end,
                    include = function(self, ...) assert(type(self) == 'table',
                            "Make sure you that you are using 'Class:include' instead of 'Class.include'")
                        for _, mixin in ipairs({ ... }) do _includeMixin(self, mixin) end
                        return self
                    end
                } }
            function middleclass.class(name, super) assert(type(name) == 'string',
                "A name (string) is needed for the new class") return super and super:subclass(name) or
                _includeMixin(_createClass(name), DefaultMixin) end
        ...
        rtk.Attribute = { FUNCTION = {}, NIL = {}, DEFAULT = {}, default = nil, type = nil, calculate = nil, priority = nil,
            reflow = nil, redraw = nil, replaces = nil, animate = nil, get = nil, set = nil, }
        setmetatable(rtk.Attribute, { __call = function(self, attrs) attrs._is_rtk_attr = true
            return attrs
        end
        })
        local falsemap = { [false] = true, [0] = true, ['0'] = true, ['false'] = true, ['False'] = true, ['FALSE'] = true
        }
        local typemaps = { number = function(v) local n = tonumber(v)
            if n then
                return n
        ...
        function rtk.Reference(attr) return { _is_rtk_reference = true, attr = attr
            }
        end
        ...
        function rtk.class(name, super, attributes) local cls = class(name, super)
    ...
    __mod_rtk_utils = (function()
        ...
        function rtk.file.read(fname) local f, err = io.open(fname)
            if f then
        ...
        function rtk.file.write(fname, contents) local f, err = io.open(fname, "w")
            if f then
                f:write(contents)
                f:close()
            else
        ...
        function rtk.file.size(fname) local f, err = io.open(fname)
            if f then
        ...
        function rtk.IndexManager:initialize(first, last) self.first = first
            self.last = last
        ...
        function rtk.IndexManager:next(gc) local idx = self:_next()
        ...
        function string.split(s, delim, filter) local parts = {}
        ...
        local function _table_tostring(tbl, seen) local result, done = {}, {}
            seen = seen or {}
        ...
        function table.shallow_copy(t, merge) local copy = {}
        ...
        function table.keys(t) local keys = {}
        ...
        function table.values(t) local values = {}
    ...
    __mod_rtk_future = (function()
        ...
        function rtk.Future:cancel(v) assert(self._cancelled, 'Future is not cancelleable')
        ...
        function rtk.Future:resolve(value) assert(self.state == rtk.Future.PENDING,
                'Future has already been resolved or cancelled')
    ...
    __mod_rtk_animate = (function()
        ...
        rtk.easing = { ['linear'] = function(x) return x
        end, ['in-sine'] = function(x) return 1 - math.cos((x * math.pi) / 2) end,
            ['out-sine'] = function(x) return math.sin((x * math.pi) / 2) end,
            ['in-out-sine'] = function(x) return -(math.cos(math.pi * x) - 1) / 2
            end, ['in-quad'] = function(x) return x * x
            end, ['out-quad'] = function(x) return 1 - (1 - x) * (1 - x) end,
            ['in-out-quad'] = function(x) return (x < 0.5) and (2 * x * x) or (1 - (-2 * x + 2) ^ 2 / 2) end,
            ['in-cubic'] = function(x) return x * x * x
            end, ['out-cubic'] = function(x) return 1 - (1 - x) ^ 4
            end, ['in-out-cubic'] = function(x) return (x < 0.5) and (4 * x * x * x) or (1 - (-2 * x + 2) ^ 3 / 2) end,
            ['in-quart'] = function(x) return x * x * x * x
            end, ['out-quart'] = function(x) return 1 - (1 - x) ^ 4
            end, ['in-out-quart'] = function(x) return (x < 0.5) and (8 * x * x * x * x) or (1 - (-2 * x + 2) ^ 4 / 2) end,
            ['in-quint'] = function(x) return x * x * x * x * x
            end, ['out-quint'] = function(x) return 1 - (1 - x) ^ 5
            end, ['in-out-quint'] = function(x) return (x < 0.5) and (16 * x * x * x * x * x) or (1 - (-2 * x + 2) ^ 5 /
                2) end, ['in-expo'] = function(x) return (x == 0) and 0 or 2 ^ (10 * x - 10) end,
            ['out-expo'] = function(x) return (x == 1) and 1 or (1 - 2 ^ (-10 * x)) end,
            ['in-out-expo'] = function(x) return (x == 0) and 0 or
                    (x == 1) and 1 or
                    (x < 0.5) and 2 ^ (20 * x - 10) / 2 or (2 - 2 ^ (-20 * x + 10)) / 2
            end, ['in-circ'] = function(x) return 1 - math.sqrt(1 - x ^ 2) end,
            ['out-circ'] = function(x) return math.sqrt(1 - (x - 1) ^ 2) end,
            ['in-out-circ'] = function(x) return (x < 0.5) and (1 - math.sqrt(1 - (2 * x) ^ 2)) / 2 or
                (math.sqrt(1 - (-2 * x + 2) ^ 2) + 1) / 2
            end, ['in-back'] = function(x) return c3 * x * x * x - c1 * x * x
            end, ['out-back'] = function(x) return 1 + (c3 * (x - 1) ^ 3) + (c1 * (x - 1) ^ 2) end,
            ['in-out-back'] = function(x) return (x < 0.5) and
                    ((2 * x) ^ 2 * ((c2 + 1) * 2 * x - c2)) / 2 or
                    ((2 * x - 2) ^ 2 * ((c2 + 1) * (x * 2 - 2) + c2) + 2) / 2
            end, ['in-elastic'] = function(x) return (x == 0) and 0 or
                    (x == 1) and 1 or
                    -2 ^ (10 * x - 10) * math.sin((x * 10 - 10.75) * c4)
            end, ['out-elastic'] = function(x) return (x == 0) and 0 or
                    (x == 1) and 1 or
            ...
            end, ['in-bounce'] = function(x) return 1 - rtk.easing['out-bounce'](1 - x) end,
            ['out-bounce'] = function(x) if x < 1 / d1 then
                    return n1 * x * x
                elseif x < (2 / d1) then
                    x = x - 1.5 / d1
                    return n1 * x * x + 0.75
        ...
        local _table_stepfuncs = { [1] = function(widget, anim) local x = anim.easingfunc(anim.pct) return { _resolve(x,
            anim.src[1], anim.dst[1]) } end,
            [2] = function(widget, anim) local x = anim.easingfunc(anim.pct)
                local src, dst = anim.src, anim.dst
                local f1 = _resolve(x, src[1], dst[1])
                local f2 = _resolve(x, src[2], dst[2])
                return { f1, f2 }
            end, [3] = function(widget, anim) local x = anim.easingfunc(anim.pct)
                local src, dst = anim.src, anim.dst
                local f1 = _resolve(x, src[1], dst[1])
                local f2 = _resolve(x, src[2], dst[2])
                local f3 = _resolve(x, src[3], dst[3])
                return { f1, f2, f3 }
            end, [4] = function(widget, anim) local x = anim.easingfunc(anim.pct)
                local src, dst = anim.src, anim.dst
                local f1 = _resolve(x, src[1], dst[1])
                local f2 = _resolve(x, src[2], dst[2])
                local f3 = _resolve(x, src[3], dst[3])
                ...
                return { f1, f2, f3, f4 }
            end, any = function(widget, anim) local x = anim.easingfunc(anim.pct)
                local src, dst = anim.src, anim.dst
                local result = {}
                for i = 1, #src do
        ...
        local function _is_equal(a, b) local ta = type(a)
            if ta ~= type(b) then
                return false
        ...
        function rtk.queue_animation(kwargs) assert(kwargs and kwargs.key, 'animation table missing key field')
            ...
            anim = table.shallow_copy(kwargs,
                { easingfunc = easingfunc, src = kwargs.src or (not kwargs.stepfunc and 0 or nil), dst = kwargs.dst or 0,
                    doneval = kwargs.doneval or kwargs.dst, pct = step, pctstep = step, duration = duration,
                    future = future, frames = 0, startfps = rtk.fps, _start_time = reaper.time_precise() })
    ...
    __mod_rtk_colour = (function()
        local rtk = __mod_rtk_core
        local log = __mod_rtk_log
        rtk.colour = {}
        function rtk.colour.set(colour, amul) local r, g, b, a = rtk.colour.rgba(colour)
            if amul then
                a = a * amul
            end
            gfx.set(r, g, b, a)
        ...
        function rtk.colour.rgba(colour) local tp = type(colour)
            if tp == 'table' then
                local r, g, b, a = table.unpack(colour)
                return r, g, b, a or 1
            elseif tp == 'string' then
                local hash = colour:find('#')
                if hash == 1 then
                    return rtk.colour.hex2rgba(colour)
                else
                    local a = 1
                    if hash then
                        a = (tonumber(colour:sub(hash + 1), 16) or 0) / 255
                        colour = colour:sub(1, hash - 1)
                    end
                    local resolved = rtk.colour.names[colour:lower()]
                    if not resolved then
                        log.warning('rtk: colour "%s" is invalid, defaulting to black', colour)
                        return 0, 0, 0, a
                    end
                    local r, g, b, _ = rtk.colour.hex2rgba(resolved)
                    return r, g, b, a
                end
            elseif tp == 'number' then
                local r, g, b = colour & 0xff, (colour >> 8) & 0xff, (colour >> 16) & 0xff
                return r / 255, g / 255, b / 255, 1
            else
                error('invalid type ' .. tp .. ' passed to rtk.colour.rgba()')
            end
        end

        function rtk.colour.luma(colour, under) local r, g, b, a = rtk.colour.rgba(colour)
            local luma = (0.2126 * r + 0.7152 * g + 0.0722 * b)
            if a < 1.0 and under then
                luma = math.abs((luma * a) + rtk.colour.luma(under) * (1 - a))
            end
            return luma
        end

        function rtk.colour.hsv(colour) local r, g, b, a = rtk.colour.rgba(colour)
            local h, s, v
        ...
        function rtk.colour.hsl(colour) local r, g, b, a = rtk.colour.rgba(colour)
            local h, s, l
            local max = math.max(r, g, b)
            local min = math.min(r, g, b)
            l = (max + min) / 2
        ...
        function rtk.colour.int(colour, native) local r, g, b, _ = rtk.colour.rgba(colour)
        local n = (r * 255) + ((g * 255) << 8) + ((b * 255) << 16)
        return native and rtk.colour.convert_native(n) or n
        end

        function rtk.colour.mod(colour, hmul, smul, vmul, amul) local h, s, v, a = rtk.colour.hsv(colour) return rtk.colour
            .hsv2rgb(rtk.clamp(h * (hmul or 1), 0, 1), rtk.clamp(s * (smul or 1), 0, 1), rtk.clamp(v * (vmul or 1), 0, 1)
                , rtk.clamp(a * (amul or 1), 0, 1)) end

        function rtk.colour.convert_native(n) if rtk.os.mac or rtk.os.linux then
                return rtk.colour.flip_byte_order(n)
            else
                return n
            end
        end

        function rtk.colour.flip_byte_order(colour) return ((colour & 0xff) << 16) | (colour & 0xff00) |
            ((colour >> 16) & 0xff) end

        function rtk.colour.get_reaper_theme_bg() if reaper.GetThemeColour then
                local r = reaper.GetThemeColour('col_tracklistbg', 0)
                if r ~= -1 then
                    return rtk.colour.int2hex(r)
                end
            end
            if reaper.GSC_mainwnd then
                local idx = (rtk.os.mac or rtk.os.linux) and 5 or 20
                return rtk.colour.int2hex(reaper.GSC_mainwnd(idx))
            end
        end

        function rtk.colour.get_icon_style(colour, under) return rtk.colour.luma(colour, under) >
            rtk.light_luma_threshold and 'dark' or 'light' end

        function rtk.colour.hex2rgba(s) local r = tonumber(s:sub(2, 3), 16) or 0
        ...
        function rtk.colour.rgba2hex(r, g, b, a) r = math.ceil(r * 255)
            b = math.ceil(b * 255)
            g = math.ceil(g * 255)
        ...
        function rtk.colour.int2hex(n, native) if native then
                n = rtk.colour.convert_native(n)
            end
            local r, g, b = n & 0xff, (n >> 8) & 0xff, (n >> 16) & 0xff
            return string.format('#%02x%02x%02x', r, g, b)
        end

        function rtk.colour.hsv2rgb(h, s, v, a) if s == 0 then
        ...
        function rtk.colour.hsl2rgb(h, s, l, a) local r, g, b
            if s == 0 then
                r, g, b = l, l, l
            else
        ...
        rtk.colour.names = { black = '#000000', silver = '#c0c0c0', gray = '#808080', white = '#ffffff', maroon = '#800000',
            ...
            orange = '#ffa500', aliceblue = '#f0f8ff', antiquewhite = '#faebd7', aquamarine = '#7fffd4', azure = '#f0ffff',
            ...
            gold = '#ffd700', goldenrod = '#daa520', greenyellow = '#adff2f', grey = '#808080', honeydew = '#f0fff0',
    ...
    __mod_rtk_font = (function()
        ...
        function rtk.Font:initialize(name, size, scale, flags) if size then
        ...
        function rtk.Font:_get_id() local idx = _idmgr:next(true)
            if idx then
                return idx
            end
            return 1
        ...
        function rtk.Font:layout(text, boxw, boxh, wrap, align, relative, spacing, breakword) self:set()
            local segments = { text = text, boxw = boxw, boxh = boxh, wrap = wrap, align = align, relative = relative,
                spacing = spacing, multiplier = rtk.font.multiplier, scale = rtk.scale.value, dirty = false,
                isvalid = function() return not self.dirty and self.scale == rtk.scale.value and
                    self.multiplier == rtk.font.multiplier
                end
            }
            ...
            local maxwidth = 0
            local y = 0
            local function addsegment(segment) local w, h = gfx.measurestr(segment)
    ...
    __mod_rtk_event = (function()
        ...
        rtk.Event.static.typenames = { [rtk.Event.MOUSEDOWN] = 'mousedown', [rtk.Event.MOUSEUP] = 'mouseup',
            [rtk.Event.MOUSEMOVE] = 'mousemove', [rtk.Event.MOUSEWHEEL] = 'mousewheel', [rtk.Event.KEY] = 'key',
            [rtk.Event.DROPFILE] = 'dropfile', }
        rtk.Event.register { type = nil, handled = nil, button = 0, buttons = 0, wheel = 0, hwheel = 0, keycode = nil,
            char = nil, ctrl = false, shift = false, alt = false, meta = false, modifiers = nil, files = nil, x = nil,
            y = nil, time = 0, simulated = nil, debug = nil, }
        function rtk.Event:initialize(attrs) self:reset()
            if attrs then
        ...
        function rtk.Event:reset(type) table.merge(self, self.class.attributes.defaults)
            self.type = type
            self.handled = nil
            self.debug = nil
            self.files = nil
        ...
        function rtk.Event:is_widget_pressed(widget) return rtk._pressed_widgets and rtk._pressed_widgets[widget.id] and
            true or false
        end
        ...
        function rtk.Event:set_modifiers(cap, button) self.modifiers = cap & (4 | 8 | 16 | 32)
            self.ctrl = cap & 4 ~= 0
            self.shift = cap & 8 ~= 0
            self.alt = cap & 16 ~= 0
            self.meta = cap & 32 ~= 0
        ...
        function rtk.Event:clone(overrides) local event = rtk.Event()
    ...
    __mod_rtk_image = (function()
        ...
        local function _search_image_paths_list(fname, paths) if not paths or #paths == 0 then
                return
            end
        ...
        function rtk.Image.static.icon(name, style) style = style or rtk.theme.iconstyle
            ...
            if path then
                ...
                if not matched then
                    img:recolour(style == 'light' and '#ffffff' or '#000000')
                end
                img.style = style
            end
            if not img then
        ...
        function rtk.Image.static.make_placeholder_icon(w, h, style) local img = rtk.Image(w or 24, h or 24)
            img:pushdest()
            rtk.colour.set({ 1, 0.2, 0.2, 1 })
        ...
        function rtk.Image:initialize(w, h, density) table.merge(self, self.class.attributes.defaults)
            if h then
        ...
        function rtk.Image:__tostring() local clsname = self.class.name:gsub('rtk.', '')
        ...
        function rtk.Image:popdest() assert(gfx.dest == self.id,
            'rtk.Image.popdest() called on image that is not the current drawing target') rtk.popdest(self.id) end

        function rtk.Image:clone() local newimg = rtk.Image(self.w, self.h)
            if self.id then
        ...
        function rtk.Image:resize(w, h, clear) w = math.ceil(w)
            h = math.ceil(h)
        ...
        function rtk.Image:scale(w, h, mode, density) assert(w or h, 'one or both of w or h parameters must be specified')
            if not self.id then
            ...
            newimg:blit { src = self, sx = self.x, sy = self.y, sw = self.w, sh = self.h, dw = newimg.w, dh = newimg.h,
                mode = mode }
            newimg.density = density or self.density
            return newimg
        end

        function rtk.Image:clear(colour) self:pushdest()
            if not colour then
                gfx.set(0, 0, 0, 0, rtk.Image.DEFAULT, self.id, 0)
                gfx.setimgdim(self.id, 0, 0)
                gfx.setimgdim(self.id, self.w, self.h)
            else
                rtk.colour.set(colour)
        ...
        function rtk.Image:viewport(x, y, w, h, density) local new = rtk.Image()
            new.id = self.id
        ...
        function rtk.Image:draw(dx, dy, a, scale, clipw, cliph, mode) return self:blit { dx = dx, dy = dy, alpha = a,
                clipw = clipw, cliph = cliph, mode = mode, scale = scale
            }
        end

        function rtk.Image:blit(attrs) attrs = attrs or {}
            ...
            if self.rotation == 0 then
                ...
                gfx.blit(src or self.id, 1.0, self.rotation, sx - (self._soffx or 0), sy - (self._soffy or 0), self._dw,
        ...
        function rtk.Image:recolour(colour) local r, g, b, _ = rtk.colour.rgba(colour) return self:filter(0, 0, 0, 1.0, r
            , g, b, 0) end

        function rtk.Image:filter(mr, mg, mb, ma, ar, ag, ab, aa) self:pushdest() gfx.muladdrect(self.x, self.y, self.w,
            self.h, mr, mg, mb, ma, ar, ag, ab, aa) self:popdest() return self
        end

        function rtk.Image:rect(colour, x, y, w, h, fill) self:pushdest() rtk.colour.set(colour) gfx.rect(x, y, w, h,
            fill) self:popdest() return self
        end
        ...
        function rtk.Image:flip_vertical() self:pushdest()
            gfx.mode = 6
            gfx.a = 1
        ...
        local function _xlate(x, y, theta) return x * math.cos(theta) - y * math.sin(theta),
            x * math.sin(theta) + y * math.cos(theta) end

        function rtk.Image:rotate(degrees) self.rotation = math.rad(degrees)
            local x1, y1 = 0, 0
    ...
    __mod_rtk_multiimage = (function()
        ...
        function rtk.MultiImage:initialize(...) rtk.Image.initialize(self)
            self._variants = {}
            local images = { ... }
        ...
        function rtk.MultiImage:clone() local new = rtk.MultiImage()
            for density, img in pairs(self._variants) do
                new:add(img:clone())
            end
        ...
        function rtk.MultiImage:scale(w, h, mode) local new = rtk.MultiImage()
            for density, img in pairs(self._variants) do
        ...
        function rtk.MultiImage:clear(colour) for density, img in pairs(self._variants) do
                img:clear(colour)
            end
        end

        function rtk.MultiImage:viewport(x, y, w, h) local new = rtk.MultiImage()
            for density, img in pairs(self._variants) do
        ...
        function rtk.MultiImage:rect(colour, x, y, w, h, fill) for density, img in pairs(self._variants) do
                img:rect(colour, x * density, y * density, w * density, h * density, fill)
            end
            return self
        end
    ...
    __mod_rtk_imagepack = (function()
        ...
        function rtk.ImagePack:initialize(attrs) table.merge(self, self.class.attributes.defaults)
            self._last_id = 0
            self._sources = {}
            self._regions = {}
            self._cache = {}
        ...
        function rtk.ImagePack:add(attrs) assert(type(attrs) == 'table', 'ImagePack:add() expects a table')
            ...
            self._sources[src_idx] = { src = attrs.src, recolours = {} }
            local y = 0
        ...
        function rtk.ImagePack:get(name, style) if not name then
            ...
            for density, region in pairs(densities) do
                ...
                if recolour then
                    img = src.recolours[style]
                    if not img then
                        img = src.img:clone():recolour(style == 'light' and '#ffffff' or '#000000')
                        src.recolours[style] = img
                    end
                end
    ...
    __mod_rtk_shadow = (function()
        ...
        rtk.Shadow.register { type = nil, colour = '#00000055', w = nil, h = nil, radius = nil, elevation = nil, }
        function rtk.Shadow:initialize(colour) self.colour = colour or self.class.attributes.colour.default
            self._image = nil
        ...
        function rtk.Shadow:_needs_generate() if self._check_generate == false then
            ...
            if gen then
                self._last_draw_params = { w = self.w, h = self.h, tt = self.tt, tr = self.tr, tb = self.tb, tl = self.tl,
                    elevation = self.elevation, radius = self.radius
                }
            end
        ...
        function rtk.Shadow:_draw_rectangle(x, y, alpha) local tt, tr, tb, tl = self.tt, self.tr, self.tb, self.tl
            ...
            if tr > 0 then
                self._image:blit { sx = pad + tl + self.w, sw = tr + pad, sh = h, dx = x + self.w, dy = y - tt - pad,
                    alpha = alpha
                }
            end
            if tb > 0 then
                self._image:blit { sy = pad + tt + self.h, sw = self.w + tl + pad, sh = tb + pad, dx = x - tl - pad,
                    dy = y + self.h, alpha = alpha
                }
            end
            if tt > 0 then
                self._image:blit { sx = 0, sy = 0, sw = self.w + tl + pad, sh = pad + tt, dx = x - tl - pad, dy = y - tt
                    - pad, alpha = alpha
                }
            end
            if tl > 0 then
                self._image:blit { sx = 0, sy = pad + tt, sw = pad + tl, sh = self.h, dx = x - tl - pad, dy = y,
                    alpha = alpha
                }
            end
        end
    ...
    __mod_rtk_nativemenu = (function()
        ...
        function rtk.NativeMenu:_parse(submenu) self._item_by_idx = {}
        self._item_by_id = {}
        self._order = self:_parse_submenu(self.menu)
        end

        function rtk.NativeMenu:_parse_submenu(submenu, baseitem) local order = baseitem or {}
        ...
        function rtk.NativeMenu:_build_menustr(submenu, items) items = items or {}
            local menustr = ''
        ...
        function rtk.NativeMenu:open(x, y) rtk.window:request_mouse_cursor(rtk.mouse.cursors.POINTER)
        ...
        function rtk.NativeMenu:open_at_widget(widget, halign, valign) assert(widget.drawn,
                "rtk.NativeMenu.open_at_widget() called before widget was drawn")
    ...
    __mod_rtk_widget = (function()
        ...
        rtk.Widget.static._calc_border = function(self, value) if type(value) == 'string' then
                ...
                if #parts == 1 then
                    return { { rtk.colour.rgba(parts[1]) }, 1 }
                elseif #parts == 2 then
                    local width = parts[1]:gsub('px', '')
                    return { { rtk.colour.rgba(parts[2]) }, tonumber(width) }
                else
            ...
            elseif value then
                ...
                if #value == 1 then
                    return { rtk.colour.rgba({ value[1] }), 1 }
                elseif #value == 2 then
                    return value
                elseif #value == 4 then
                    return { value, 1 }
        ...
        rtk.Widget.register { x = rtk.Attribute { default = 0, reflow = rtk.Widget.REFLOW_FULL },
            y = rtk.Attribute { default = 0, reflow = rtk.Widget.REFLOW_FULL },
            w = rtk.Attribute { type = 'number', reflow = rtk.Widget.REFLOW_FULL,
                animate = function(self, anim) local val = anim.resolve(anim.easingfunc(anim.pct)) return (
                    anim.dst > 1.0 and val > 0 and val <= 1.0) and 1.01 or val, val == anim.dst
                end
            }, h = rtk.Attribute { type = 'number', reflow = rtk.Widget.REFLOW_FULL, animate = rtk.Reference('w'), },
            ...
            halign = rtk.Attribute { default = rtk.Widget.LEFT,
                calculate = { left = rtk.Widget.LEFT, center = rtk.Widget.CENTER, right = rtk.Widget.RIGHT }, },
            valign = rtk.Attribute { default = rtk.Widget.TOP,
                calculate = { top = rtk.Widget.TOP, center = rtk.Widget.CENTER, bottom = rtk.Widget.BOTTOM }, },
            scalability = rtk.Attribute { default = rtk.Widget.FULL, reflow = rtk.Widget.REFLOW_FULL,
                calculate = { box = rtk.Widget.BOX, full = rtk.Widget.FULL }, },
            position = rtk.Attribute { default = rtk.Widget.RELATIVE, reflow = rtk.Widget.REFLOW_FULL,
                calculate = { relative = rtk.Widget.RELATIVE, absolute = rtk.Widget.ABSOLUTE, fixed = rtk.Widget.FIXED,
                    ['fixed-flow'] = rtk.Widget.FIXED_FLOW
                }, }, box = nil, offx = nil, offy = nil, clientx = nil, clienty = nil,
            padding = rtk.Attribute { replaces = { 'tpadding', 'rpadding', 'bpadding', 'lpadding' },
                get = function(self, attr, target) return { target.tpadding, target.rpadding, target.bpadding,
                    target.lpadding } end, reflow = rtk.Widget.REFLOW_FULL,
                calculate = function(self, attr, value, target) local t, r, b, l = rtk.Widget.static._calc_padding_or_margin(value)
            ...
            rpadding = rtk.Reference('tpadding'), bpadding = rtk.Reference('tpadding'),
            lpadding = rtk.Reference('tpadding'),
            margin = rtk.Attribute { default = 0, replaces = { 'tmargin', 'rmargin', 'bmargin', 'lmargin' },
                get = function(self, attr, target) return { target.tmargin, target.rmargin, target.bmargin,
                    target.lmargin } end, reflow = rtk.Widget.REFLOW_FULL,
                calculate = function(self, attr, value, target) local t, r, b, l = rtk.Widget.static._calc_padding_or_margin(value)
            ...
            rmargin = rtk.Reference('tmargin'), bmargin = rtk.Reference('tmargin'), lmargin = rtk.Reference('tmargin'),
            border = rtk.Attribute { reflow = rtk.Widget.REFLOW_FULL,
                calculate = function(self, attr, value, target) local border = rtk.Widget.static._calc_border(self, value)
            ...
            tborder = rtk.Attribute { priority = true, reflow = rtk.Widget.REFLOW_FULL,
                calculate = function(self, attr, value, target) target.border_uniform = false
                    return rtk.Widget.static._calc_border(self, value)
                end, }, rborder = rtk.Reference('tborder'), bborder = rtk.Reference('tborder'),
            lborder = rtk.Reference('tborder'), visible = rtk.Attribute { default = true, reflow = rtk.Widget.REFLOW_FULL },
            disabled = false, ghost = false, tooltip = nil, cursor = nil,
            alpha = rtk.Attribute { default = 1.0, reflow = rtk.Widget.REFLOW_NONE, }, autofocus = false,
            bg = rtk.Attribute { calculate = function(self, attr, value, target) return value and
                { rtk.colour.rgba(value) } end, }, scroll_on_drag = true, show_scrollbar_on_drag = true,
            touch_activate_delay = nil, realized = false, drawn = false, viewport = nil, window = nil, mouseover = false,
            hovering = false, debug = nil, id = nil, ref = nil, refs = nil, }
        rtk.Widget.static.last_index = 0
        function rtk.Widget:__allocate() self.__id = tostring(rtk.Widget.static.last_index)
        rtk.Widget.static.last_index = rtk.Widget.static.last_index + 1

        end

        function rtk.Widget:initialize(attrs, ...) self.refs = { __empty = true }
            setmetatable(self.refs,
                { __mode = 'v', __index = function(table, key) return self:_ref(table, key) end,
                    __newindex = function(table, key, value) rawset(table, key, value) table.__empty = false
                    end
                })
        ...
        function rtk.Widget:__tostring() local clsname = self.class.name:gsub('rtk.', '')
        ...
        function rtk.Widget:_get_debug_colour() if not self.debug_colour then
                local function hashint(i, seed) math.randomseed(i * (seed * 53)) return math.random(40, 235) / 255.0
                end

                local id = self.id:hash()
                self.debug_colour = { hashint(id, 1), hashint(id, 2), hashint(id, 3), }
            end
            return self.debug_colour
        end
        ...
        function rtk.Widget:_draw_debug_box(offx, offy, event) local calc = self.calc
            ...
            local colour = self:_get_debug_colour()
            gfx.set(colour[1], colour[2], colour[3], 0.2)
            local x = calc.x + offx
            local y = calc.y + offy
            gfx.rect(x, y, calc.w, calc.h, 1)
            gfx.set(colour[1], colour[2], colour[3], 0.4)
            gfx.rect(x, y, calc.w, calc.h, 0)
            local tp, rp, bp, lp = self:_get_padding_and_border()
            if tp > 0 or rp > 0 or bp > 0 or lp > 0 then
                gfx.set(colour[1], colour[2], colour[3], 0.8)
        ...
        function rtk.Widget:_draw_debug_info(event) local calc = self.calc
            local parts = { { 15, "#6e2e2e", tostring(self.class.name:gsub("rtk.", "")) },
                { 15, "#378b48", string.format('#%s', self.id) }, { 17, "#cccccc", " | " },
                { 15, "#555555", string.format("%.1f", calc.x) }, { 15, "#777777", " , " },
                { 15, "#555555", string.format("%.1f", calc.y) }, { 17, "#cccccc", " | " },
                { 15, "#555555", string.format("%.1f", calc.w) }, { 13, "#777777", "  x  " },
            ...
            rtk.colour.set('#ffffff')
            gfx.rect(x, y, bw, bh, 1)
            rtk.colour.set('#777777')
            gfx.rect(x, y, bw, bh, 0)
            gfx.x = x + 10
            for n, part in ipairs(parts) do
                local sz, colour, str = table.unpack(part)
                rtk.colour.set(colour)
        ...
        function rtk.Widget:sync(attr, value, calculated, trigger, reflow) return self:_attr(attr, value, trigger, reflow
            , calculated, true) end

        function rtk.Widget:_attr(attr, value, trigger, reflow, calculated, sync) local meta = self.class.attributes.get(attr)
        ...
        function rtk.Widget:_set_calc_attr(attr, value, calculated, target, meta) meta = meta or
                self.class.attributes.get(attr)
            if meta.set then
        ...
        function rtk.Widget:scrolltoview(margin, allowh, allowv, smooth) if not self.visible or not self.box or
                not self.viewport then
                return self
            end
            local calc = self.calc
        ...
        function rtk.Widget:animate(kwargs) assert(kwargs and (kwargs.attr or #kwargs > 0), 'missing animation arguments')
            local calc = self.calc
        ...
        function rtk.Widget:cancel_animation(attr) local anim = self:get_animation(attr)
            if anim then
                anim.future:cancel()
            end
            return anim
        ...
        function rtk.Widget:setcolour(colour, amul) rtk.colour.set(colour, (amul or 1) * self.calc.alpha) return self
        end
        ...
        function rtk.Widget:queue_reflow(mode, widget) local window = self:_slow_get_window()
            if window then
        ...
        function rtk.Widget:_get_padding() local calc = self.calc
            ...
            return (calc.tpadding or 0) * scale, (calc.rpadding or 0) * scale, (calc.bpadding or 0) * scale,
                (calc.lpadding or 0) * scale
        end

        function rtk.Widget:_get_border_sizes() local calc = self.calc
            return calc.tborder and calc.tborder[2] or 0, calc.rborder and calc.rborder[2] or 0,
                calc.bborder and calc.bborder[2] or 0, calc.lborder and calc.lborder[2] or 0
        end

        function rtk.Widget:_get_padding_and_border() local tp, rp, bp, lp = self:_get_padding()
        ...
        local function _get_content_dimension(size, bounds, padding, fill, clamp, flags, scale) scale = flags &
                rtk.Widget.FULL == rtk.Widget.FULL and (rtk.scale.value * (scale or 1)) or scale or 1
            if size then
        ...
        function rtk.Widget:_reflow(boxx, boxy, boxw, boxh, fillw, fillh, clampw, clamph, uiscale, viewport, window) local calc = self
                .calc
        ...
        function rtk.Widget:_draw_bg(offx, offy, alpha, event) local calc = self.calc
            if calc.bg and not calc.ghost then
                self:setcolour(calc.bg, alpha)
                gfx.rect(calc.x + offx, calc.y + offy, calc.w, calc.h, 1)
            end
        end

        function rtk.Widget:_draw_tooltip(clientx, clienty, clientw, clienth) local font = rtk.Font(table.unpack(rtk.theme
            .tooltip_font))
        local segments, w, h = font:layout(self.calc.tooltip, clientw - 10, clienth - 10, true)
        rtk.colour.set(rtk.theme.tooltip_bg) local x = rtk.clamp(clientx, 0, clientw - w - 10)
        local y = rtk.clamp(clienty + 16, 0, clienth - h - 10 - self.calc.h)
        gfx.rect(x, y, w + 10, h + 10, 1) rtk.colour.set(rtk.theme.tooltip_text) gfx.rect(x, y, w + 10, h + 10, 0) font:
            draw(segments, x + 5, y + 5, w, h) end

        function rtk.Widget:_unpack_border(border, alpha) local colour, thickness = table.unpack(border)
            if colour then
                self:setcolour(colour or rtk.theme.button, alpha * self.calc.alpha)
            end
        ...
        function rtk.Widget:_deferred_mousedown(event, x, y) local mousedown_handled = event:get_button_state('mousedown-handled')
            if not mousedown_handled and event:is_widget_pressed(self) and not event:get_button_state(self) then
                local downevent = event:clone { type = rtk.Event.MOUSEDOWN, simulated = true, x = x or event.x,
                    y = y or event.y }
        ...
        function rtk.Widget:_accept_mousedown(event, duration, state) event:set_button_state('mousedown-handled', self)
            event:set_handled(self)
        ...
        function rtk.Widget:_handle_attr(attr, value, oldval, trigger, reflow, sync) local ok = self:onattr(attr, value,
                oldval, trigger, sync)
            if ok ~= false then
                local redraw
        ...
        function rtk.Widget:_handle_mousedown(event) local ok = self:onmousedown(event)
            if ok ~= false then
        ...
        function rtk.Widget:_handle_mouseenter(event) local ok = self:onmouseenter(event)
            if ok ~= false then
        ...
        function rtk.Widget:_handle_dragstart(event, x, y, t) local draggable, droppable = self:ondragstart(event, x, y,
                t)
        ...
        function rtk.Widget:_handle_dropmousemove(event, source, dragarg) return self:ondropmousemove(event, source,
            dragarg) end
    ...
    __mod_rtk_viewport = (function()
        ...
        rtk.Viewport.register { [1] = rtk.Attribute { alias = 'child' },
            child = rtk.Attribute { reflow = rtk.Widget.REFLOW_FULL },
            scroll_left = rtk.Attribute { default = 0, reflow = rtk.Widget.REFLOW_NONE,
                calculate = function(self, attr, value, target) return math.round(value) end, },
            scroll_top = rtk.Reference('scroll_left'), smoothscroll = rtk.Attribute { reflow = rtk.Widget.REFLOW_NONE },
            scrollbar_size = 15,
            vscrollbar = rtk.Attribute { default = rtk.Viewport.SCROLLBAR_HOVER,
                calculate = { never = rtk.Viewport.SCROLLBAR_NEVER, always = rtk.Viewport.SCROLLBAR_ALWAYS,
                    hover = rtk.Viewport.SCROLLBAR_HOVER, }, },
            vscrollbar_offset = rtk.Attribute { default = 0, reflow = rtk.Widget.REFLOW_NONE, }, vscrollbar_gutter = 25,
            hscrollbar = rtk.Attribute { default = rtk.Viewport.SCROLLBAR_NEVER, calculate = rtk.Reference('vscrollbar'), },
            hscrollbar_offset = 0, hscrollbar_gutter = 25, flexw = false, flexh = true, shadow = nil, elevation = 20,
            show_scrollbar_on_drag = false, touch_activate_delay = 0, }
        function rtk.Viewport:initialize(attrs, ...) rtk.Widget.initialize(self, attrs, self.class.attributes.defaults,
                ...)
        ...
        function rtk.Viewport:_handle_attr(attr, value, oldval, trigger, reflow, sync) local ok = rtk.Widget._handle_attr(self
                , attr, value, oldval, trigger, reflow, sync)
            if ok == false then
                return ok
            end
            if attr == 'child' then
            ...
            elseif attr == 'bg' then
                ...
                local luma = rtk.colour.luma(value)
                ...
                self._scrollbar_colour = luma < 0.5 and '#ffffff' or '#000000'
        ...
        function rtk.Viewport:_reflow(boxx, boxy, boxw, boxh, fillw, fillh, clampw, clamph, uiscale, viewport, window) local calc = self
                .calc
            calc.x, calc.y = self:_get_box_pos(boxx, boxy)
            local w, h, tp, rp, bp, lp = self:_get_content_size(boxw, boxh, fillw, fillh, clampw, clamph)
            ...
            if child and child.visible == true then
                ...
                local wx, wy, ww, wh = child:reflow(0, 0, inner_maxw, inner_maxh, false, false, not calc.flexw,
                    not calc.flexh, uiscale, self, window
                )
        ...
        function rtk.Viewport:_draw(offx, offy, alpha, event, clipw, cliph, cltargetx, cltargety, parentx, parenty) rtk.Widget
                ._draw(self, offx, offy, alpha, event, clipw, cliph, cltargetx, cltargety, parentx, parenty)
            local calc = self.calc
            local pre = self._pre
        ...
        function rtk.Viewport:_draw_scrollbars(offx, offy, cltargetx, cltargety, alpha, event) local calc = self.calc
            ...
            if calc.vscrollbar == rtk.Viewport.SCROLLBAR_ALWAYS or
                ...
                local should_handle_hovering = rtk.point_in_box(event.x, event.y, scrx + cltargetx, scry + cltargety,
                ...
                self:setcolour(self._scrollbar_colour)
        ...
        function rtk.Viewport:_handle_event(clparentx, clparenty, event, clipped, listen) local calc = self.calc
            ...
            if (not event.handled or event.type == rtk.Event.MOUSEMOVE) and
                ...
                self:_clamp()
                self.child:_handle_event(x - calc.scroll_left + pre.lp + child.calc.lmargin,
        ...
        function rtk.Viewport:_handle_dragstart(event, x, y, t) local draggable, droppable = self:ondragstart(self, event
                , x, y, t)
            if draggable ~= nil then
                return draggable, droppable
            end
        ...
        function rtk.Viewport:_handle_dragmousemove(event, arg) local ok = rtk.Widget._handle_dragmousemove(self, event)
        ...
        function rtk.Viewport:_handle_dragend(event, arg) local ok = rtk.Widget._handle_dragend(self, event)
            if ok == false then
                return ok
            end
            local vscrollbar, lasty, samples, natural = table.unpack(arg)
            if natural then
                ...
                local duration = 1
                self:animate { attr = 'scroll_top', dst = y, duration = duration, easing = 'out-cubic' }:done(function() self
                    :_reset_touch_scroll() end):cancelled(function() self:_reset_touch_scroll() end)
            end
            self:queue_draw()
            event:set_handled(self)
            return true
        ...
        function rtk.Viewport:_get_clamped_scroll(left, top) return rtk.clamp(left, 0, self._scroll_clamp_left),
            rtk.clamp(top, 0, self._scroll_clamp_top) end
    ...
    __mod_rtk_popup = (function()
        ...
        rtk.Popup.register { anchor = rtk.Attribute { reflow = rtk.Widget.REFLOW_FULL },
            margin = rtk.Attribute { default = 20, reflow = rtk.Widget.REFLOW_FULL, },
            width_from_anchor = rtk.Attribute { default = true, reflow = rtk.Widget.REFLOW_FULL, },
            overlay = rtk.Reference('bg'), autoclose = true, opened = false,
            bg = rtk.Attribute { default = function(self, attr) return rtk.theme.popup_bg or
                { rtk.colour.mod(rtk.theme.bg, 1, 1, rtk.theme.popup_bg_brightness, 0.96) } end, },
            border = rtk.Attribute { default = function(self, attr) return rtk.theme.popup_border
            end, }, shadow = rtk.Attribute { default = function() return rtk.theme.popup_shadow
            end, }, visible = false, elevation = 35, padding = 10, z = 1000, }
        function rtk.Popup:initialize(attrs, ...) rtk.Viewport.initialize(self, attrs, self.class.attributes.defaults,
            ...) end

        function rtk.Popup:_handle_event(clparentx, clparenty, event, clipped, listen) rtk.Viewport._handle_event(self,
                clparentx, clparenty, event, clipped, listen)
            if event.type == rtk._touch_activate_event and self.mouseover then
                event:set_handled(self)
            end
        end

        function rtk.Popup:_reflow(boxx, boxy, boxw, boxh, fillw, fillh, clampw, clamph, rescale, viewport, window) local calc = self
                .calc
        ...
        function rtk.Popup:_draw(offx, offy, alpha, event, clipw, cliph, cltargetx, cltargety, parentx, parenty) if self
                .calc.overlay then
                self:setcolour(self.calc.overlay, alpha)
        ...
        function rtk.Popup:close() if not self.calc.visible or self.closed then
            ...
            self.closed = true
            self:animate { attr = 'alpha', dst = 0, duration = 0.15 }:done(function() self:hide() self:attr('alpha', 1) self
                .window:remove(self) end)
            rtk.reset_modal()
        end
    end)()
    ...
    __mod_rtk_container = (function()
        ...
        rtk.Container.register { fillw = nil, fillh = nil, halign = nil, valign = nil, padding = nil, tpadding = nil,
            rpadding = nil, bpadding = nil, lpadding = nil, minw = nil, minh = nil, maxw = nil, maxh = nil, bg = nil,
            z = nil, children = nil, }
        function rtk.Container:initialize(attrs, ...) self.children = {}
        ...
        function rtk.Container:_handle_mouseenter(event) local ret = self:onmouseenter(event)
            if ret ~= false then
        ...
        function rtk.Container:_handle_mousemove(event) local ret = rtk.Widget._handle_mousemove(self, event)
        ...
        function rtk.Container:_draw_debug_box(offx, offy, event) if not rtk.Widget._draw_debug_box(self, offx, offy,
                event) then
                return
            end
            gfx.set(1, 1, 1, 1)
        ...
        function rtk.Container:_validate_child(child) assert(rtk.isa(child, rtk.Widget),
            'object being added to container is not subclassed from rtk.Widget') end

        function rtk.Container:_reparent_child(child) self:_validate_child(child)
        ...
        function rtk.Container:add(widget, attrs) self:_reparent_child(widget)
        ...
        function rtk.Container:update(widget, attrs, merge) local n = self:get_child_index(widget)
        ...
        function rtk.Container:insert(pos, widget, attrs) self:_reparent_child(widget)
        ...
        function rtk.Container:remove(widget) local n = self:get_child_index(widget)
            if n ~= nil then
                self:remove_index(n)
                return n
            end
        ...
        function rtk.Container:reorder(widget, targetidx) local srcidx = self:get_child_index(widget)
        ...
        function rtk.Container:reorder_before(widget, target) local targetidx = self:get_child_index(target) return self
            :reorder(widget, targetidx) end

        function rtk.Container:reorder_after(widget, target) local targetidx = self:get_child_index(target) return self:
            reorder(widget, targetidx + 1) end
        ...
        function rtk.Container:_determine_zorders() local zs = {}
        ...
        function rtk.Container:_get_cell_padding(widget, attrs) local calc = widget.calc
            local scale = rtk.scale.value
            return ((attrs.tpadding or 0) + (calc.tmargin or 0)) * scale,
                ((attrs.rpadding or 0) + (calc.rmargin or 0)) * scale, ((attrs.bpadding or 0) + (calc.bmargin or 0)) *
                scale, ((attrs.lpadding or 0) + (calc.lmargin or 0)) * scale
        end

        function rtk.Container:_set_cell_box(attrs, x, y, w, h) attrs._cellbox = { math.round(x), math.round(y),
            math.round(w), math.round(h) } end

        function rtk.Container:_reflow(boxx, boxy, boxw, boxh, fillw, fillh, clampw, clamph, uiscale, viewport, window) local calc = self
                .calc
            ...
            for n, widgetattrs in ipairs(self.children) do
                ...
                if widget.visible == true then
                    ...
                    local wx, wy, ww, wh = widget:reflow(0, 0,
                        rtk.clamprel(inner_maxw - widget.x - clp - crp, attrs.minw or wcalc.minw,
                            attrs.maxw or wcalc.maxw),
                        rtk.clamprel(inner_maxh - widget.y - ctp - cbp, attrs.minh or wcalc.minh,
                            attrs.maxh or wcalc.maxh), attrs.fillw, attrs.fillh, clampw or attrs.maxw ~= nil,
                        clamph or attrs.maxh ~= nil, uiscale, viewport, window
                    )
        ...
        function rtk.Container:_draw(offx, offy, alpha, event, clipw, cliph, cltargetx, cltargety, parentx, parenty) local calc = self
                .calc
            ...
            for _, z in ipairs(self._z_indexes) do
                for _, widgetattrs in ipairs(self._reflowed_children[z]) do
                    ...
                    if attrs.bg and attrs._cellbox then
                        local cb = attrs._cellbox
                        self:setcolour(attrs.bg, child_alpha)
        ...
        function rtk.Container:_unrealize() rtk.Widget._unrealize(self)
            for i = 1, #self.children do
                local widget = self.children[i][1]
                if widget and widget.realized then
                    widget:_unrealize()
    ...
    __mod_rtk_window = (function()
        ...
        function rtk.Window.static._make_icons() local w, h = 12, 12
            local sz = 2
            local icon = rtk.Image(w, h)
            icon:pushdest()
            rtk.colour.set(rtk.theme.dark and { 1, 1, 1, 1 } or { 0, 0, 0, 1 })
            for row = 0, 2 do
                for col = 0, 2 do
                    local n = row * 3 + col
                    if n == 2 or n >= 4 then
        ...
        rtk.Window.register { x = rtk.Attribute { type = 'number', reflow = rtk.Widget.REFLOW_NONE, redraw = false,
            window_sync = true, },
            y = rtk.Attribute { type = 'number', reflow = rtk.Widget.REFLOW_NONE, redraw = false, window_sync = true, },
            w = rtk.Attribute { priority = true, type = 'number', window_sync = true,
                calculate = function(self, attr, value, target) return value and
                    math.max(self.minw or 0, value) * rtk.scale.framebuffer
                end, },
            h = rtk.Attribute { priority = true, window_sync = true,
                calculate = function(self, attr, value, target) return math.max(self.minh or 0, value or 0) *
                    rtk.scale.framebuffer
                end, },
            minw = rtk.Attribute { default = 100,
                calculate = function(self, attr, value, target) return value and value * rtk.scale.framebuffer or 0
                end, }, minh = rtk.Attribute { default = 30, calculate = rtk.Reference('minw'), },
            maxw = rtk.Attribute { default = 800,
                calculate = function(self, attr, value, target) return value and value * rtk.scale.framebuffer
                end, }, maxh = rtk.Attribute { default = 600, calculate = rtk.Reference('maxw'), },
            visible = rtk.Attribute { window_sync = true, },
            docked = rtk.Attribute { default = false, window_sync = true, reflow = rtk.Widget.REFLOW_NONE, },
            dock = rtk.Attribute { default = rtk.Window.DOCK_RIGHT,
                calculate = { bottom = rtk.Window.DOCK_BOTTOM, left = rtk.Window.DOCK_LEFT, top = rtk.Window.DOCK_TOP,
                    right = rtk.Window.DOCK_RIGHT, floating = rtk.Window.DOCK_FLOATING
                }, window_sync = true, reflow = rtk.Widget.REFLOW_NONE, },
            pinned = rtk.Attribute { default = false, window_sync = true,
                calculate = function(self, attr, value, target) return rtk.has_js_reascript_api and value
                end, }, borderless = rtk.Attribute { default = false, window_sync = true,
                calculate = rtk.Reference('pinned') }, [1] = rtk.Attribute { alias = 'title' },
            title = rtk.Attribute { default = 'REAPER application', reflow = rtk.Widget.REFLOW_NONE, window_sync = true,
                redraw = false, },
            opacity = rtk.Attribute { default = 1.0, reflow = rtk.Widget.REFLOW_NONE, window_sync = true, redraw = false, },
            resizable = rtk.Attribute { default = true, reflow = rtk.Widget.REFLOW_NONE, window_sync = true, }, hwnd = nil,
            in_window = false, is_focused = not rtk.has_js_reascript_api and true or false, running = false,
            cursor = rtk.mouse.cursors.POINTER, scalability = rtk.Widget.BOX, }
        function rtk.Window:initialize(attrs, ...) rtk.Container.initialize(self, attrs, self.class.attributes.defaults,
                ...)
            rtk.window = self
            self.window = self
            if self.id == 0 and self.calc.bg and rtk.theme.default then
                rtk.set_theme_by_bgcolour(self.calc.bg)
            end
        ...
        function rtk.Window:_handle_attr(attr, value, oldval, trigger, reflow, sync) local ok = rtk.Widget._handle_attr(self
                , attr, value, oldval, trigger, reflow, sync)
            if ok == false then
                return ok
            end
            if attr == 'bg' then
                local colour = rtk.colour.int(value or rtk.theme.bg)
                gfx.clear = colour
                if rtk.has_js_reascript_api then
                    if self._gdi_brush then
                        ...
                        reaper.atexit(function() reaper.JS_GDI_DeleteObject(self._gdi_brush) reaper.JS_GDI_DeleteObject(self
                            ._gdi_pen) end)
                    end
                    colour = rtk.colour.flip_byte_order(colour)
                    self._gdi_brush = reaper.JS_GDI_CreateFillBrush(colour)
                    self._gdi_pen = reaper.JS_GDI_CreatePen(1, colour)
                end
            end
        ...
        function rtk.Window:_clear_gdi(startw, starth) if not rtk.os.windows or not rtk.has_js_reascript_api or
                not self.hwnd then
                return
            end
            local calc = self.calc
        ...
        function rtk.Window:_run() self:_update()
            if self.running then
                rtk.defer(self._run, self)
            end
        end

        function rtk.Window:_get_display_resolution(working) local x = math.floor(self.x)
        ...
        function rtk.Window:_sync_window_attrs(overrides) local calc = self.calc
            ...
            if not calc.docked then
                ...
                local function restyle() reaper.JS_Window_SetStyle(self.hwnd, style)
        ...
        function rtk.Window:_setup_borderless() if self._move_grip then
            ...
            move.onmousedown = function(this, event) if not calc.docked and calc.borderless then
            ...
            move.ondragmousemove = function(this, event) local _, wx, wy, _, wy2 = reaper.JS_Window_GetClientRect(self.hwnd)
                local mx, my = reaper.GetMousePosition()
            ...
            local resize = rtk.ImageBox { image = rtk.Window._icon_resize_grip, z = 10000, visible = calc.resizable,
                cursor = rtk.mouse.cursors.SIZE_NW_SE, alpha = 0.4, autofocus = true, touch_activate_delay = 0,
                tooltip = 'Resize window', }
            resize.onmouseenter = function(this) if calc.borderless then
            ...
            resize.ondragmousemove = function(this, event) local _, ww, wh = reaper.JS_Window_GetClientSize(self.hwnd)
                local mx, my = reaper.GetMousePosition()
        ...
        local function verify_hwnd_coords(hwnd, x, y) local _, hx, hy, _, _ = reaper.JS_Window_GetClientRect(hwnd) return hx
            == x and hy == y
        end
        ...
        function rtk.Window:_discover_os_window_frame_size(hwnd) local _, w, h = reaper.JS_Window_GetClientSize(hwnd)
        ...
        function rtk.Window:_get_content_size(boxw, boxh, fillw, fillh, clampw, clamph, scale) local tp, rp, bp, lp = self
        ...
        function rtk.Window:_reflow(boxx, boxy, boxw, boxh, fillw, filly, clampw, clamph, uiscale, viewport, window) rtk
                .Container._reflow(self, boxx, boxy, boxw, boxh, fillw, filly, clampw, clamph, uiscale, viewport, window)
            self.calc.x = 0
            self.calc.y = 0
        end
        ...
        function rtk.Window:reflow(mode, shrinkwrapw, shrinkwraph) local calc = self.calc
            ...
            if mode ~= rtk.Widget.REFLOW_FULL and widgets and self.realized and #widgets < 20 then
                ...
                local _, _, w, h = rtk.Container.reflow(self, 0, 0, boxw, boxh, nil, nil, true, true, rtk.scale.value,
                    nil, self
                )
                self:_realize_geometry()
                full = true
        ...
        function rtk.Window:_get_mousemove_event(simulated) local event = self._event:reset(rtk.Event.MOUSEMOVE)
        ...
        function rtk.Window:request_mouse_cursor(cursor, force) if cursor and
                (self.calc.cursor == rtk.mouse.cursors.UNDEFINED or force) then
    ...
    __mod_rtk_box = (function()
        ...
        rtk.Box.register { expand = rtk.Attribute { type = 'number' }, fillw = false, fillh = false,
            stretch = rtk.Attribute { calculate = { none = rtk.Box.STRETCH_NONE, full = rtk.Box.STRETCH_FULL,
                siblings = rtk.Box.STRETCH_TO_SIBLINGS, ['true'] = rtk.Box.STRETCH_FULL, ['false'] = rtk.Box.STRETCH_NONE,
                [true] = rtk.Box.STRETCH_FULL, [false] = rtk.Box.STRETCH_NONE, [rtk.Attribute.NIL] = rtk.Box.STRETCH_NONE, } },
            bg = nil, orientation = nil, spacing = rtk.Attribute { default = 0, reflow = rtk.Widget.REFLOW_FULL, }, }
        function rtk.Box:initialize(attrs, ...) rtk.Container.initialize(self, attrs, self.class.attributes.defaults, ...) assert(self
            .orientation, 'rtk.Box cannot be instantiated directly, use rtk.HBox or rtk.VBox instead') end
        ...
        function rtk.Box:_reflow(boxx, boxy, boxw, boxh, fillw, fillh, clampw, clamph, uiscale, viewport, window) local calc = self
                .calc
            calc.x, calc.y = self:_get_box_pos(boxx, boxy)
            local w, h, tp, rp, bp, lp = self:_get_content_size(boxw, boxh, fillw, fillh, clampw, clamph)
            local inner_maxw = w or (boxw - lp - rp)
            ...
            self._reflowed_children = {}
            self._child_index_by_id = {}
            local innerw, innerh, expand_unit_size, expw, exph = self:_reflow_step1(inner_maxw, inner_maxh, clampw,
                clamph, uiscale, viewport, window
            )
            ...
            innerw, innerh = self:_reflow_step2(inner_maxw, inner_maxh, innerw, innerh, clampw, clamph, expand_unit_size
                , uiscale, viewport, window, tp, rp, bp, lp
            )
            ...
            for n, widgetattrs in ipairs(self.children) do
                ...
                elseif widget.visible == true then
                    ...
                    if attrs._calculated_expand == 0 then
                        ...
                        local ctp, crp, cbp, clp = self:_get_cell_padding(widget, attrs)
                        if orientation == rtk.Box.HORIZONTAL then
                            local child_maxw = rtk.clamprel(remaining_size - clp - crp - spacing,
                                attrs.minw or wcalc.minw, attrs.maxw or wcalc.maxw
                            )
                            local child_maxh = rtk.clamprel(h - ctp - cbp, attrs.minh or wcalc.minh,
                                attrs.maxh or wcalc.maxh
                            )
                            _, _, ww, wh, wexpw, wexph = widget:reflow(0, 0, child_maxw, child_maxh, attrs.fillw,
                                attrs.fillh and attrs.stretch ~= rtk.Box.STRETCH_TO_SIBLINGS, clampw, clamph, uiscale,
                                viewport, window
                            )
                            expw = wexpw or expw
                            exph = wexph or exph
                            ...
                            local child_maxw = rtk.clamprel(w - clp - crp, attrs.minw or wcalc.minw,
                                attrs.maxw or wcalc.maxw
                            )
                            local child_maxh = rtk.clamprel(remaining_size - ctp - cbp - spacing,
                                attrs.minh or wcalc.minh, attrs.maxh or wcalc.maxh
                            )
                            _, _, ww, wh, wexpw, wexph = widget:reflow(0, 0, child_maxw, child_maxh,
                                attrs.fillw and attrs.stretch ~= rtk.Box.STRETCH_TO_SIBLINGS, attrs.fillh, clampw, clamph
    ...
    __mod_rtk_vbox = (function()
        ...
        function rtk.VBox:_reflow_step2(w, h, maxw, maxh, clampw, clamph, expand_unit_size, uiscale, viewport, window, tp
                                        , rp, bp, lp) local offset = 0
            local spacing = 0
            local second_pass = {}
            for n, widgetattrs in ipairs(self.children) do
                local widget, attrs = table.unpack(widgetattrs)
                ...
                elseif widget.visible == true then
                    ...
                    if expand and expand > 0 then
                        ...
                        local child_maxh = rtk.clamprel((expand_unit_size * expand) - ctp - cbp - spacing,
                            attrs.minh or wcalc.minh, attrs.maxh or wcalc.maxh
                        )
            ...
            if #second_pass > 0 then
                for n, widgetinfo in ipairs(second_pass) do
                    ...
                    if attrs.stretch == rtk.Box.STRETCH_TO_SIBLINGS then
                        wx, wy, ww, wh = widget:reflow(0, 0, maxw, child_maxh, attrs.fillw, attrs.fillh, clampw, clamph,
                            uiscale, viewport, window
                        )
                    end
    ...
    __mod_rtk_hbox = (function()
        ...
        function rtk.HBox:_reflow_step2(w, h, maxw, maxh, clampw, clamph, expand_unit_size, uiscale, viewport, window, tp
                                        , rp, bp, lp) local offset = 0
            local spacing = 0
            local second_pass = {}
            for n, widgetattrs in ipairs(self.children) do
                ...
                elseif widget.visible == true then
                    ...
                    local expand = attrs._calculated_expand
                    if expand and expand > 0 then
                        local child_maxw = rtk.clamprel((expand_unit_size * expand) - clp - crp - spacing,
                            attrs.minw or wcalc.minw, attrs.maxw or wcalc.maxw
                        )
            ...
            if #second_pass > 0 then
                for n, widgetinfo in ipairs(second_pass) do
                    ...
                    if attrs.stretch == rtk.Box.STRETCH_TO_SIBLINGS then
                        wx, wy, ww, wh = widget:reflow(0, 0, child_maxw, maxh, attrs.fillw, attrs.fillh, clampw, clamph,
                            uiscale, viewport, window
                        )
                    end
    ...
    __mod_rtk_flowbox = (function()
        ...
        rtk.FlowBox.register { vspacing = rtk.Attribute { default = 0, reflow = rtk.Widget.REFLOW_FULL, },
            hspacing = rtk.Attribute { default = 0, reflow = rtk.Widget.REFLOW_FULL, }, }
        function rtk.FlowBox:initialize(attrs, ...) rtk.Container.initialize(self, attrs, self.class.attributes.defaults
            , ...) end

        function rtk.FlowBox:_reflow(boxx, boxy, boxw, boxh, fillw, fillh, clampw, clamph, uiscale, viewport, window) local calc = self
                .calc
            local x, y = self:_get_box_pos(boxx, boxy)
            local w, h, tp, rp, bp, lp = self:_get_content_size(boxw, boxh, fillw, fillh, clampw, clamph)
            local inner_maxw = w or (boxw - lp - rp)
            ...
            for _, widgetattrs in ipairs(self.children) do
                ...
                if wcalc.visible == true and wcalc.position & rtk.Widget.POSITION_INFLOW ~= 0 then
                    local ctp, crp, cbp, clp = self:_get_cell_padding(widget, attrs)
                    local wx, wy, ww, wh = widget:reflow(0, 0, inner_maxw, inner_maxh, nil, nil, clampw, clamph, uiscale
                        , viewport, window
                    )
                    ww = ww + clp + crp
                    wh = wh + ctp + cbp
    ...
    __mod_rtk_spacer = (function()
        ...
        function rtk.Spacer:_draw(offx, offy, alpha, event, clipw, cliph, cltargetx, cltargety, parentx, parenty) rtk.Widget
                ._draw(self, offx, offy, alpha, event, clipw, cliph, cltargetx, cltargety, parentx, parenty)
            local calc = self.calc
            local y = calc.y + offy
    ...
    __mod_rtk_button = (function()
        ...
        rtk.Button.register { [1] = rtk.Attribute { alias = 'label' }, label = rtk.Attribute { reflow = rtk.Widget.REFLOW_FULL },
            icon = rtk.Attribute { priority = true, reflow = rtk.Widget.REFLOW_FULL,
                calculate = function(self, attr, value, target) if type(value) == 'string' then
                        local colour = self.colour
                        if self.calc.flat == rtk.Button.FLAT then
                            colour = rtk.theme.bg
                        end
                        local style = rtk.colour.get_icon_style(colour, rtk.theme.bg)
                ...
                end, }, wrap = rtk.Attribute { default = false, reflow = rtk.Widget.REFLOW_FULL, },
            colour = rtk.Attribute { default = function(self, attr) return rtk.theme.button
            end,
                calculate = function(self, attr, value, target) local colour = rtk.Widget.attributes.bg.calculate(self,
                        attr, value, target)
                    local luma = rtk.colour.luma(colour, rtk.theme.bg)
                    ...
                    self._theme = theme
                    if not self.textcolour then
                        target.textcolour = { rtk.colour.rgba(theme.button_label) }
                    end
                    return colour
                end, }, textcolour = rtk.Attribute { default = nil, calculate = rtk.Reference('bg'), },
            textcolour2 = rtk.Attribute { default = function(self, attr) return rtk.theme.text
            end, calculate = rtk.Reference('bg'), },
            iconpos = rtk.Attribute { default = rtk.Widget.LEFT, calculate = rtk.Reference('halign'), }, tagged = false,
            flat = rtk.Attribute { default = rtk.Button.RAISED,
                calculate = { raised = rtk.Button.RAISED, flat = rtk.Button.FLAT, label = rtk.Button.LABEL,
                    [rtk.Attribute.NIL] = rtk.Button.RAISED, }, }, tagalpha = nil, surface = true,
            spacing = rtk.Attribute { default = 10, reflow = rtk.Widget.REFLOW_FULL, }, gradient = 1,
            circular = rtk.Attribute { default = false, reflow = rtk.Widget.REFLOW_FULL, },
            elevation = rtk.Attribute { default = 3,
                calculate = function(self, attr, value, target) return rtk.clamp(value, 0, 15) end
            }, hover = false, font = rtk.Attribute { default = function(self, attr) return self._theme_font[1]
            end, reflow = rtk.Widget.REFLOW_FULL, },
            fontsize = rtk.Attribute { default = function(self, attr) return self._theme_font[2]
            end, reflow = rtk.Widget.REFLOW_FULL, }, fontscale = rtk.Attribute { default = 1.0,
        ...
        function rtk.Button:initialize(attrs, ...) self._theme = rtk.theme
        ...
        function rtk.Button:_handle_attr(attr, value, oldval, trigger, reflow, sync) local ret = rtk.Widget._handle_attr(self
                , attr, value, oldval, trigger, reflow, sync)
            if ret == false then
                return ret
            end
            ...
            if type(self.icon) == 'string' and (attr == 'colour' or attr == 'label') then
        ...
        function rtk.Button:_reflow(boxx, boxy, boxw, boxh, fillw, fillh, clampw, clamph, uiscale, viewport, window) local calc = self
                .calc
            calc.x, calc.y = self:_get_box_pos(boxx, boxy)
            local w, h, tp, rp, bp, lp = self:_get_content_size(boxw, boxh, fillw, fillh, clampw, clamph)
        ...
        function rtk.Button:_realize_geometry() if self.circular then
            ...
            self._pre = { tp = tp, rp = rp, bp = bp, lp = lp, ix = ix, iy = iy, lx = lx, ly = ly, lw = lw, lh = lh,
                tagx = tagx, tagw = tagw, surx = surx, sury = sury, surw = surw or 0, surh = surh or 0, clipw = clipw,
                cliph = cliph, iw = icon and (icon.w * iscale), ih = icon and (icon.h * iscale), }
        end

        function rtk.Button:_draw(offx, offy, alpha, event, clipw, cliph, cltargetx, cltargety, parentx, parenty) local calc = self
                .calc
        ...
        function rtk.Button:_draw_circular_button(x, y, hover, clicked, gradient, brightness, cmul, bmul, alpha) local calc = self
                .calc
            ...
            if calc.surface and (not calc.flat or hover or clicked) then
                ...
                local r, g, b, a = rtk.colour.mod(calc.colour, 1.0, 1.0, brightness)
                self:setcolour({ r * cmul, g * cmul, b * cmul, a }, alpha)
            ...
            if calc.border then
                local colour, thickness = table.unpack(calc.border)
        ...
        function rtk.Button:_draw_rectangular_button(x, y, hover, clicked, gradient, brightness, cmul, bmul, alpha) local calc = self
                .calc
            local pre = self._pre
            local amul = calc.alpha * alpha
            local label_over_surface = calc.surface and (calc.flat == rtk.Button.RAISED or hover)
            local textcolour = label_over_surface and calc.textcolour or calc.textcolour2
            ...
            if surw > 0 and surh > 0 and draw_surface then
                ...
                local r, g, b, a = rtk.colour.rgba(calc.colour)
                local sr, sg, sb, sa = rtk.colour.mod({ r, g, b, a }, 1.0, 1.0, brightness * lmul, amul)
            ...
            if calc.label then
                self:setcolour(textcolour, alpha)
                self._font:draw(self._segments, x + pre.lx, y + pre.ly, pre.clipw, pre.cliph)
            end
        end

        function rtk.Button:_draw_icon(x, y, hovering, alpha) self.calc.icon:draw(x, y, self.calc.alpha * alpha,
            rtk.scale.value) end
    end)()
    ...
    __mod_rtk_entry = (function()
        ...
        rtk.Entry.static.contextmenu = { { 'Undo', id = 'undo' }, rtk.NativeMenu.SEPARATOR, { 'Cut', id = 'cut' },
            { 'Copy', id = 'copy' }, { 'Paste', id = 'paste' }, { 'Delete', id = 'delete' }, rtk.NativeMenu.SEPARATOR,
            { 'Select All', id = 'select_all' }, }
        rtk.Entry.register { [1] = rtk.Attribute { alias = 'value' },
            value = rtk.Attribute { default = '', reflow = rtk.Widget.REFLOW_NONE,
                calculate = function(self, attr, value, target) return value and tostring(value) or '' end, },
            textwidth = rtk.Attribute { reflow = rtk.Widget.REFLOW_FULL },
            icon = rtk.Attribute { reflow = rtk.Widget.REFLOW_FULL,
                calculate = function(self, attr, value, target) if type(value) == 'string' then
                        local icon = self.calc.icon
                        local style = rtk.colour.get_icon_style(self.calc.bg or rtk.theme.bg, rtk.theme.bg)
            ...
            }, placeholder = rtk.Attribute { default = nil, reflow = rtk.Widget.REFLOW_FULL, },
            textcolour = rtk.Attribute { default = function(self, attr) return rtk.theme.text
            end, calculate = rtk.Reference('bg') },
            border_hover = rtk.Attribute { default = function(self, attr) return { rtk.theme.entry_border_hover, 1 } end,
                reflow = rtk.Widget.REFLOW_FULL,
                calculate = function(self, attr, value, target) return rtk.Widget.static._calc_border(self, value) end, },
            border_focused = rtk.Attribute { default = function(self, attr) return { rtk.theme.entry_border_focused, 1 } end,
                reflow = rtk.Widget.REFLOW_FULL, calculate = rtk.Reference('border_hover'), }, blink = true,
            caret = rtk.Attribute { type = 'number', default = 1, priority = true, reflow = rtk.Widget.REFLOW_NONE,
                calculate = function(self, attr, value, target) return rtk.clamp(value, 1, #(target.value or '') + 1) end, },
            font = rtk.Attribute { reflow = rtk.Widget.REFLOW_FULL,
                default = function(self, attr) return self._theme_font[1]
                end
            },
            fontsize = rtk.Attribute { reflow = rtk.Widget.REFLOW_FULL,
                default = function(self, attr) return self._theme_font[2]
                end
        ...
        function rtk.Entry:initialize(attrs, ...) self._theme_font = rtk.theme.entry_font or rtk.theme.default_font
            rtk.Widget.initialize(self, attrs, self.class.attributes.defaults, ...)
            self._positions = { 0 }
            self._backingstore = nil
            self._font = rtk.Font()
        ...
        function rtk.Entry:_reflow(boxx, boxy, boxw, boxh, fillw, fillh, clampw, clamph, uiscale, viewport, window) local calc = self
                .calc
        ...
        function rtk.Entry:_handle_focus(event, context) local ok = rtk.Widget._handle_focus(self, event, context)
        self._dirty_text = self._dirty_text or (ok and self._selstart)
        return ok
        end

        function rtk.Entry:_handle_blur(event, other) local ok = rtk.Widget._handle_blur(self, event, other)
        self._dirty_text = self._dirty_text or (ok and self._selstart)
        return ok
        end
        ...
        local function is_word_break_character(value, pos) local c = value:sub(pos, pos) return c ~= '_' and
            c:match('[%c%p%s]') end
        ...
        function rtk.Entry:cut() local copied = self:copy()
            if copied then
                self:delete()
            end
            return copied
        ...
        function rtk.Entry:paste() local str = rtk.clipboard.get()
            if str and str ~= '' then
                self:push_undo()
                self:_edit(str, true)
                return str
        ...
        function rtk.Entry:_handle_mousedown(event) local ok = rtk.Widget._handle_mousedown(self, event)
            if ok == false then
                return ok
            end
        ...
        function rtk.Entry:_handle_keypress(event) local ok = rtk.Widget._handle_keypress(self, event)
            if ok == false then
                return ok
            end
            local calc = self.calc
            ...
            self._caretctr = 0
            log.debug2('keycode=%s char=%s caret=%s ctrl=%s shift=%s meta=%s alt=%s sel=%s-%s', event.keycode, event.char
                , calc.caret, event.ctrl, event.shift, event.meta, event.alt, self._selstart, self._selend
            )
            return true
        end
        ...
        function rtk.Entry:_handle_dragmousemove(event) local ok = rtk.Widget._handle_dragmousemove(self, event)
            if ok == false then
                return ok
            end
        ...
        function rtk.Entry:_handle_click(event) local ok = rtk.Widget._handle_click(self, event)
        ...
        function rtk.Entry:_handle_doubleclick(event) local ok = rtk.Widget._handle_doubleclick(self, event)
            if ok == false or event.button ~= rtk.mouse.BUTTON_LEFT then
                return ok
            end
        ...
        function rtk.Entry:_rendertext(x, y) self._font:set()
            ...
            if self._selstart and self:focused() then
                local a, b = self:get_selection_range()
                self:setcolour(rtk.theme.entry_selection_bg)
                gfx.rect(self._positions[a] - self._loffset, 0, self._positions[b] - self._positions[a],
                    self._backingstore.h, 1
                )
            end
            self:setcolour(self.calc.textcolour)
            self._font:draw(self.calc.value, -self._loffset, rtk.os.mac and 1 or 0)
            self._backingstore:popdest()
            self._dirty_text = false
        end

        function rtk.Entry:_draw(offx, offy, alpha, event, clipw, cliph, cltargetx, cltargety, parentx, parenty) local calc = self
                .calc
            ...
            self._backingstore:blit { sx = 0, sy = 0, sw = calc.w - lp - rp, sh = calc.h - tp - bp, dx = x + lp, dy = y +
                tp, alpha = amul, mode = rtk.Image.FAST_BLIT
            }
            if calc.placeholder and #calc.value == 0 then
                self._font:set()
                self:setcolour(rtk.theme.entry_placeholder, alpha)
            ...
            if focused then
                ...
                if self._caretctr % 32 < 16 and showcursor then
                    ...
                    self:setcolour(calc.textcolour, alpha)
    ...
    __mod_rtk_text = (function()
        ...
        rtk.Text.register { [1] = rtk.Attribute { alias = 'text' },
            text = rtk.Attribute { default = 'Text', reflow = rtk.Widget.REFLOW_FULL, },
            colour = rtk.Attribute { default = function(self, attr) return rtk.theme.text
            end, calculate = rtk.Reference('bg'), },
            wrap = rtk.Attribute { default = rtk.Text.WRAP_NONE, reflow = rtk.Widget.REFLOW_FULL,
                calculate = { ['none'] = rtk.Text.WRAP_NONE, ['normal'] = rtk.Text.WRAP_NORMAL,
                    ['break-word'] = rtk.Text.WRAP_BREAK_WORD
                }, }, textalign = rtk.Attribute { default = nil, calculate = rtk.Reference('halign'), }, overflow = false,
            spacing = rtk.Attribute { default = 0, reflow = rtk.Widget.REFLOW_FULL, },
            font = rtk.Attribute { default = function(self, attr) return self._theme_font[1]
            end, reflow = rtk.Widget.REFLOW_FULL, },
            fontsize = rtk.Attribute { default = function(self, attr) return self._theme_font[2]
            end, reflow = rtk.Widget.REFLOW_FULL, }, fontscale = rtk.Attribute { default = 1.0,
                reflow = rtk.Widget.REFLOW_FULL, },
        ...
        function rtk.Text:initialize(attrs, ...) self._theme_font = self._theme_font or rtk.theme.text_font or
                rtk.theme.default_font
        ...
        function rtk.Text:_handle_attr(attr, value, oldval, trigger, reflow, sync) if attr == 'text' and
                reflow == rtk.Widget.REFLOW_DEFAULT and self.w and not self.calc.wrap then
                if not value:find('\n') and not oldval:find('\n') then
        ...
        function rtk.Text:_reflow(boxx, boxy, boxw, boxh, fillw, fillh, clampw, clamph, uiscale, viewport, window) local calc = self
                .calc
            calc.x, calc.y = self:_get_box_pos(boxx, boxy)
            self._font:set(calc.font, calc.fontsize, calc.fontscale, calc.fontflags)
            local w, h, tp, rp, bp, lp = self:_get_content_size(boxw, boxh, fillw, fillh, clampw, clamph)
            ...
            if not seg or seg.boxw ~= lmaxw or not seg.isvalid() then
                self._segments, self.lw, self.lh = self._font:layout(calc.text, lmaxw, lmaxh,
                    calc.wrap ~= rtk.Text.WRAP_NONE, self.textalign and calc.textalign or calc.halign, true, calc.spacing
        ...
        function rtk.Text:_draw(offx, offy, alpha, event, clipw, cliph, cltargetx, cltargety, parentx, parenty) rtk.Widget
                ._draw(self, offx, offy, alpha, event, clipw, cliph, cltargetx, cltargety, parentx, parenty)
            local calc = self.calc
            local x, y = calc.x + offx, calc.y + offy
            if y + calc.h < 0 or y > cliph or calc.ghost then
            ...
            self:_handle_drawpre(offx, offy, alpha, event)
            self:_draw_bg(offx, offy, alpha, event)
            self:setcolour(calc.colour, alpha)
    ...
    __mod_rtk_heading = (function()
        ...
        rtk.Heading.register { colour = rtk.Attribute { default = function(self, attr) return rtk.theme.heading or
            rtk.theme.text
        end
        }, }
        function rtk.Heading:initialize(attrs, ...) self._theme_font = self._theme_font or rtk.theme.heading_font or
                rtk.theme.default_font
    ...
    __mod_rtk_imagebox = (function()
        ...
        rtk.ImageBox.register { [1] = rtk.Attribute { alias = 'image' },
            image = rtk.Attribute { calculate = rtk.Entry.attributes.icon.calculate, reflow = rtk.Widget.REFLOW_FULL, },
            scale = rtk.Attribute { reflow = rtk.Widget.REFLOW_FULL, },
            aspect = rtk.Attribute { reflow = rtk.Widget.REFLOW_FULL, }, }
        function rtk.ImageBox:initialize(attrs, ...) rtk.Widget.initialize(self, attrs, self.class.attributes.defaults,
            ...) end

        function rtk.ImageBox:_handle_attr(attr, value, oldval, trigger, reflow, sync) local ret = rtk.Widget._handle_attr(self
                , attr, value, oldval, trigger, reflow, sync)
            if ret == false then
                return ret
            end
        ...
        function rtk.ImageBox:_reflow(boxx, boxy, boxw, boxh, fillw, fillh, clampw, clamph, uiscale, viewport, window) local calc = self
                .calc
            calc.x, calc.y = self:_get_box_pos(boxx, boxy)
            local w, h, tp, rp, bp, lp = self:_get_content_size(boxw, boxh, fillw, fillh, clampw, clamph, self.scale or 1
            )
            local dstw, dsth = 0, 0
            local hpadding = lp + rp
            local vpadding = tp + bp
        ...
        function rtk.ImageBox:_draw(offx, offy, alpha, event, clipw, cliph, cltargetx, cltargety, parentx, parenty) rtk.Widget
                ._draw(self, offx, offy, alpha, event, clipw, cliph, cltargetx, cltargety, parentx, parenty)
            local calc = self.calc
            local x, y = calc.x + offx, calc.y + offy
            ...
            self:_handle_drawpre(offx, offy, alpha, event)
            self:_draw_bg(offx, offy, alpha, event)
            calc.image:blit { dx = x + pre.ix, dy = y + pre.iy, dw = self.iw, dh = self.ih, alpha = calc.alpha * alpha,
                clipw = calc.w, cliph = calc.h, }
            self:_draw_borders(offx, offy, alpha)
            self:_handle_draw(offx, offy, alpha, event)
        end
    end)()
    ...
    __mod_rtk_optionmenu = (function()
        ...
        rtk.OptionMenu.register { [1] = rtk.Attribute { alias = 'menu' }, menu = nil,
            icononly = rtk.Attribute { default = false, reflow = rtk.Widget.REFLOW_FULL, }, selected = nil,
            selected_index = nil, selected_id = nil, selected_item = nil,
            icon = rtk.Attribute { default = function(self) return rtk.OptionMenu.static._icon
            end, }, iconpos = rtk.Widget.RIGHT, tagged = true, lpadding = 10,
            rpadding = rtk.Attribute { default = function(self) return (self.icononly or self.circular) and self.lpadding
                or 7
            end
            }, tagalpha = 0.15, }
        function rtk.OptionMenu:initialize(attrs, ...) if not rtk.OptionMenu._icon then
                local icon = rtk.Image(13, 17)
                icon:pushdest(icon.id)
                rtk.colour.set(rtk.theme.text)
        ...
        function rtk.OptionMenu:_reflow_get_max_label_size(boxw, boxh) local segments, lw, lh = rtk.Button._reflow_get_max_label_size(self
                , boxw, boxh)
            local w, h = 0, 0
        ...
        function rtk.OptionMenu:_handle_attr(attr, value, oldval, trigger, reflow, sync) local ok = rtk.Button._handle_attr(self
                , attr, value, oldval, trigger, reflow, sync)
            if ok == false then
                return ok
            end
        ...
        function rtk.OptionMenu:open() assert(self.menu, 'menu attribute was not set on OptionMenu')
            self._menu:open_at_widget(self):done(function(item) if item then
                    self:sync('selected', item.id or item.index, nil, true)
                end
            end)
        end

        function rtk.OptionMenu:_handle_mousedown(event) local ok = rtk.Button._handle_mousedown(self, event)
            if ok == false then
                return ok
            end
            self:open()
    ...
    __mod_rtk_checkbox = (function()
        ...
        function rtk.CheckBox.static._make_icons() local w, h = 18, 18
            ...
            if rtk.theme.dark then
                colours = { border = { 1, 1, 1, 0.90 }, fill = { 1, 1, 1, 1 }, check = { 0, 0, 0, 1 },
                    checkaa = { 0.4, 0.4, 0.4, 1 }, iborder = { 1, 1, 1, 0.92 }, }
            else
                colours = { border = { 0, 0, 0, 0.90 }, fill = { 0, 0, 0, 1 }, check = { 1, 1, 1, 1 },
                    checkaa = { 0.6, 0.6, 0.6, 1 }, iborder = { 0, 0, 0, 0.92 }, }
            end
            local icon = rtk.Image(w, h)
            icon:pushdest()
            rtk.colour.set(colours.border)
            ...
            icon = rtk.Image(w, h)
            icon:pushdest()
            rtk.colour.set(colours.fill)
            rtk.gfx.roundrect(wp, hp, w - wp * 2, h - hp * 2, 2, 1)
            rtk.colour.set(colours.fill)
            gfx.rect(wp + 1, hp + 1, w - wp * 2 - 2, h - hp * 2 - 2, 1)
            rtk.colour.set(colours.checkaa)
            gfx.x = wp + 3
            gfx.y = hp + 6
            gfx.lineto(wp + 5, hp + 9)
            gfx.lineto(wp + 10, hp + 3)
            rtk.colour.set(colours.check)
            gfx.x = wp + 2
            gfx.y = hp + 6
            ...
            icon:pushdest()
            rtk.colour.set(colours.iborder)
            gfx.rect(wp + 3, hp + 3, w - wp * 2 - 6, h - hp * 2 - 6)
            rtk.colour.set(colours.fill)
            gfx.rect(wp + 4, hp + 4, w - wp * 2 - 8, h - hp * 2 - 8, 1)
            icon:popdest()
            rtk.CheckBox.static._icon_intermediate = icon
            rtk.CheckBox.static._icon_hover = rtk.CheckBox.static._icon_unchecked:clone():recolour(rtk.theme.accent)
        end

        rtk.CheckBox.register { type = rtk.Attribute { default = rtk.CheckBox.DUALSTATE,
            calculate = { dualstate = rtk.CheckBox.DUALSTATE, tristate = rtk.CheckBox.TRISTATE
            }, }, label = nil,
            value = rtk.Attribute { default = rtk.CheckBox.UNCHECKED,
                calculate = { [rtk.Attribute.NIL] = rtk.CheckBox.UNCHECKED, checked = rtk.CheckBox.static.CHECKED,
                    unchecked = rtk.CheckBox.static.UNCHECKED, indeterminate = rtk.CheckBox.static.INDETERMINATE, } },
            icon = rtk.Attribute { default = function(self, attr) return self._value_map[rtk.CheckBox.UNCHECKED]
            end, }, surface = false, valign = rtk.Widget.TOP, wrap = true, tpadding = 0, rpadding = 0, lpadding = 0,
            bpadding = 0, }
        function rtk.CheckBox:initialize(attrs, ...) if rtk.CheckBox.static._icon_unchecked == nil then
                rtk.CheckBox._make_icons()
            end
            self._value_map = { [rtk.CheckBox.UNCHECKED] = rtk.CheckBox._icon_unchecked,
        ...
        function rtk.CheckBox:_handle_click(event) local ret = rtk.Button._handle_click(self, event)
            if ret == false then
                return ret
            end
            self:toggle()
        ...
        function rtk.CheckBox:_handle_attr(attr, value, oldval, trigger, reflow, sync) local ret = rtk.Button._handle_attr(self
                , attr, value, oldval, trigger, reflow, sync)
            if ret ~= false then
                if attr == 'value' then
        ...
        function rtk.CheckBox:_draw_icon(x, y, hovering, alpha) rtk.Button._draw_icon(self, x, y, hovering, alpha)
            if hovering then
    ...
    __mod_rtk_application = (function()
        ...
        function rtk.Application:initialize(attrs, ...) self.screens = { stack = {}, }
            self.toolbar = rtk.HBox { bg = rtk.theme.bg, spacing = 0, z = 110, }
            self.toolbar:add(rtk.HBox.FLEXSPACE)
            self.statusbar = rtk.HBox { bg = rtk.theme.bg, lpadding = 10, tpadding = 5, bpadding = 5, rpadding = 10,
                z = 110, }
            self.statusbar.text = self.statusbar:add(rtk.Text { colour = rtk.theme.text_faded, text = "" }, { expand = 1 })
        ...
        function rtk.Application:_handle_attr(attr, value, oldval, trigger, reflow, sync) local ok = rtk.VBox._handle_attr(self
                , attr, value, oldval, trigger, reflow, sync)
            if ok == false then
                return ok
            end
        ...
        function rtk.Application:add_screen(screen, name) assert(type(screen) == 'table' and screen.init,
                'screen must be a table containing an init() function')
        ...
        function rtk.Application:_show_screen(screen) screen = type(screen) == 'table' and screen or self.screens[screen
            ...
            if screen then
                ...
                screen.widget:show()
                self:replace(self._content_position, screen.widget, { expand = 1, fillw = true, fillh = true,
                    minw = screen.minw
                })
                screen.toolbar:show()
            end
        ...
        function rtk.Application:replace_screen(screen, idx) screen = type(screen) == 'table' and screen or
                self.screens[screen]
            assert(screen, 'screen not found, was add_screen() called?')
    ...
    __mod_rtk_slider = (function()
        ...
        rtk.Slider.register { [1] = rtk.Attribute { alias = 'value' },
            value = rtk.Attribute { default = 0, priority = true, reflow = rtk.Widget.REFLOW_NONE,
                calculate = function(self, attr, value, target) return type(value) == 'table' and value or { value } end,
                set = function(self, attr, value, calculated, target) self._use_scalar_value = type(value) ~= 'table'
            ...
            }, colour = rtk.Attribute { type = 'colour', default = function(self, attr) return rtk.theme.slider
            end, calculate = rtk.Reference('bg'), },
            trackcolour = rtk.Attribute { type = 'colour', default = function(self, attr) return rtk.theme.slider_track
            end, calculate = rtk.Reference('bg'), }, thumbsize = rtk.Attribute { default = 6,
                reflow = rtk.Widget.REFLOW_FULL, }, thumbcolour = rtk.Attribute { type = 'colour', },
            ticklabels = rtk.Attribute { reflow = rtk.Widget.REFLOW_FULL, },
            ticklabelcolour = rtk.Attribute { type = 'colour',
                default = function(self, attr) return rtk.theme.slider_tick_label or rtk.theme.text
                end, }, spacing = rtk.Attribute { default = 2, reflow = rtk.Widget.REFLOW_FULL, },
            ticks = rtk.Attribute { default = rtk.Slider.TICKS_NEVER,
                calculate = { never = rtk.Slider.TICKS_NEVER, always = rtk.Slider.TICKS_ALWAYS,
                    ['when-active'] = rtk.Slider.TICKS_WHEN_ACTIVE, ['false'] = rtk.Slider.TICKS_NEVER,
                    [false] = rtk.Slider.TICKS_NEVER, ['true'] = rtk.Slider.TICKS_ALWAYS, [true] = rtk.Slider.TICKS_ALWAYS, },
                set = function(self, attr, value, calculated, target) self._tick_alpha = calculated ==
                        rtk.Slider.TICKS_ALWAYS and 1 or 0
                    target.ticks = calculated
                end, }, ticksize = rtk.Attribute { default = 4, reflow = rtk.Widget.REFLOW_FULL, },
            tracksize = rtk.Attribute { default = 2, reflow = rtk.Widget.REFLOW_FULL, }, min = 0, max = 100,
            step = rtk.Attribute { type = 'number',
                calculate = function(self, attr, value, target) return value and value > 0 and value
        ...
        function rtk.Slider:initialize(attrs, ...) self._thumbs = {}
            self._tick_alpha = 0
        ...
        function rtk.Slider:_handle_attr(attr, value, oldval, trigger, reflow, sync) local ok = rtk.Widget._handle_attr(self
                , attr, value, oldval, trigger, reflow, sync)
            if ok == false then
                return ok
            end
        ...
        function rtk.Slider:_reflow(boxx, boxy, boxw, boxh, fillw, fillh, clampw, clamph, uiscale, viewport, window) local calc = self
                .calc
            calc.x, calc.y = self:_get_box_pos(boxx, boxy)
            local w, h, tp, rp, bp, lp = self:_get_content_size(boxw, boxh, fillw, fillh, clampw, clamph)
            local hpadding = lp + rp
        ...
        function rtk.Slider:_realize_geometry() local calc = self.calc
            local tp, rp, bp, lp = self:_get_padding_and_border()
            local scale = rtk.scale.value
            local track = { x = calc.x + lp + calc.thumbsize * scale,
                y = calc.y + tp + ((calc.h - tp - bp - self.lh) - calc.tracksize * scale) / 2,
                w = calc.w - lp - rp - calc.thumbsize * 2 * scale, h = calc.tracksize * scale, }
            local ticks
            if calc.step then
        ...
        function rtk.Slider:_get_thumb(idx) assert(self._pre, '_get_thumb() called before reflow')
        ...
        function rtk.Slider:_set_thumb_value(thumbidx, value, animate, fast) value = self:_clamp_value_to_step(value)
        ...
        function rtk.Slider:_is_mouse_over(clparentx, clparenty, event) if not self.window or not self.window.in_window then
            ...
            if not event:is_widget_pressed(self) then
                self._hovering_thumb = nil
                if rtk.point_in_box(event.x, event.y, trackx - radius, y - radius, calc.w + radius * 2, calc.h + radius *
                    2) then
                    for i = 1, #self._thumbs do
                        local thumb = self:_get_thumb(i)
        ...
        function rtk.Slider:_handle_mouseleave(event) local ok = rtk.Widget._handle_mouseleave(self, event)
            if ok == false then
                return ok
            end
        ...
        function rtk.Slider:_handle_mousedown(event) local ok = rtk.Widget._handle_mousedown(self, event)
            if ok == false then
                return ok
            end
        ...
        function rtk.Slider:_handle_mouseup(event) local ok = rtk.Widget._handle_mouseup(self, event) self:
            _animate_thumb_overlays(event, nil, true) self:_animate_ticks(false) return ok
        end

        function rtk.Slider:_handle_dragstart(event, x, y, t) local draggable, droppable = self:ondragstart(self, event,
                x, y, t)
            if draggable ~= nil then
                return draggable, droppable
            end
        ...
        function rtk.Slider:_handle_dragmousemove(event, arg) local ok = rtk.Widget._handle_dragmousemove(self, event)
            if ok == false or event.simulated then
                return ok
            end
        ...
        function rtk.Slider:_handle_focus(event, context) self:_animate_thumb_overlays(event, true) return rtk.Widget._handle_focus(self
            , event, context) end
        ...
        function rtk.Slider:_handle_keypress(event) local ok = rtk.Widget._handle_keypress(self, event)
        ...
        function rtk.Slider:_animate_thumb_overlays(event, focused, force) if rtk.dnd.dragging and not force then
            ...
            for i = 1, #self._thumbs do
                ...
                if dst ~= nil and dst ~= thumb.radius_target then
                    ...
                    rtk.queue_animation { key = string.format('%s.thumb.%d.hover', self.id, thumb.idx), src = thumb.radius,
                        dst = dst, duration = 0.2, easing = 'out-sine', update = function(val) thumb.radius = val
                            self:queue_draw()
                        end, }
                end
            end
        ...
        function rtk.Slider:_animate_ticks(on) local calc = self.calc
            if calc.step and calc.ticks == rtk.Slider.TICKS_WHEN_ACTIVE then
                ...
                rtk.queue_animation { key = string.format('%s.ticks', self.id), src = self._tick_alpha, dst = dst,
                    duration = 0.2, easing = 'out-sine', update = function(val) self._tick_alpha = val
                        self:queue_draw()
                    end, }
            else
        ...
        function rtk.Slider:_draw(offx, offy, alpha, event, clipw, cliph, cltargetx, cltargety, parentx, parenty) rtk.Widget
                ._draw(self, offx, offy, alpha, event, clipw, cliph, cltargetx, cltargety, parentx, parenty)
            local calc = self.calc
            local y = calc.y + offy
            if y + calc.h < 0 or y > cliph or self.calc.ghost then
            ...
            self:_handle_drawpre(offx, offy, alpha, event)
            self:_draw_bg(offx, offy, alpha, event)
            self:setcolour(calc.trackcolour, alpha)
            ...
            if drawticks then
                ...
                self:setcolour('black', tickalpha)
                for i = 1, #ticks do
            ...
            for i = 1, #self._thumbs do
                ...
                if not calc.disabled then
                    if #self._thumbs == 1 or i > 1 then
                        ...
                        if drawticks then
                            self:setcolour('white', tickalpha)
                    ...
                    if thumb.radius > 0 then
                        self:setcolour(calc.thumbcolour or calc.colour, 0.25 * alpha)
            ...
            if not calc.disabled then
                self:setcolour(calc.thumbcolour or calc.colour, alpha)
            end
            for i = 1, #thumbs do
                local pos = thumbs[i]
            ...
            if self._label_segments then
                if not calc.disabled then
                    self:setcolour(calc.ticklabelcolour, alpha)
                end
                for n, segments in ipairs(self._label_segments) do
    ...
    local function init() rtk.script_path = ({ reaper.get_action_context() })[2]:match('^.+[\\//]')
        ...
        rtk.set_theme_by_bgcolour(rtk.colour.get_reaper_theme_bg() or '#262626')
